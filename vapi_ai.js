(function (oe) {
  ...
  var Cl = (oe, ve, Ee) =>
    ve in oe
      ...
      : (oe[ve] = Ee);
  var V = (oe, ve, Ee) => (
    Cl(oe, typeof ve != "symbol" ? ve + "" : ve, Ee), Ee
  );
  var oe =
    typeof globalThis < "u"
      ? globalThis
  ...
  function ln(n, e) {
    ...
    if (Object.getOwnPropertySymbols) {
      ...
      for (r = 0; r < s.length; r++)
        (t = s[r]),
          e.indexOf(t) >= 0 ||
            (Object.prototype.propertyIsEnumerable.call(n, t) && (i[t] = n[t]));
    }
    return i;
  }
  function se(n, e) {
  ...
  function hr(n, e) {
    for (var t = 0; t < e.length; t++) {
      ...
      (r.enumerable = r.enumerable || !1),
        ...
        Object.defineProperty(n, dr(r.key), r);
    }
  }
  function ae(n, e, t) {
    return (
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
  ...
  var mr,
    ...
    gr =
      We && typeof We.apply == "function"
        ? We.apply
        : function (n, e, t) {
            return Function.prototype.apply.call(n, e, t);
          };
  mr =
    We && typeof We.ownKeys == "function"
      ? We.ownKeys
    ...
    (D.prototype.removeListener = function (n, e) {
      ...
      if (t === e || t.listener === e)
        --this._eventsCount == 0
          ...
          : (delete r[n],
            r.removeListener &&
              this.emit("removeListener", n, t.listener || e));
        ...
        i === 0
          ...
          t.length === 1 && (r[n] = t[0]),
          r.removeListener !== void 0 && this.emit("removeListener", n, c || e);
      }
      return this;
    }),
  ...
  function X(n, e) {
    ...
    if (n && e && (t = n.constructor) === e.constructor) {
      ...
      if (t === Set) {
        ...
        for (r of n)
          if (((i = r) && typeof i == "object" && !(i = Mr(e, i))) || !e.has(i))
            return !1;
        return !0;
      }
      if (t === Map) {
        ...
        for (r of n)
          if (
            ((i = r[0]) && typeof i == "object" && !(i = Mr(e, i))) ||
            !X(r[1], e.get(i))
          )
            return !1;
        return !0;
  ...
  class _ {
    ...
    static compareVersions(e, t, r = !1) {
      ...
      const u = _.map([e, t], (h) => {
        ...
        return _.map(
          m.split("."),
          (y) => new Array(20 - y.length).join("0") + y
        ).reverse();
      });
    ...
    Ks = [
      {
        ...
        describe(n) {
          const e = { name: "Googlebot" },
            t =
              _.getFirstMatch(/googlebot\/(\d+(\.\d+))/i, n) ||
              _.getFirstMatch(x, n);
      ...
      },
      {
        ...
        describe(n) {
          const e = { name: "Opera" },
            t =
              _.getFirstMatch(x, n) ||
              _.getFirstMatch(/(?:opera)[\s/](\d+(\.?_?\d+)+)/i, n);
          return t && (e.version = t), e;
        },
      },
      {
        ...
        describe(n) {
          const e = { name: "Opera" },
            t =
              _.getFirstMatch(/(?:opr|opios)[\s/](\S+)/i, n) ||
              _.getFirstMatch(x, n);
          return t && (e.version = t), e;
        },
      },
      {
        ...
        describe(n) {
          const e = { name: "Samsung Internet for Android" },
            t =
              _.getFirstMatch(x, n) ||
              _.getFirstMatch(/(?:SamsungBrowser)[\s/](\d+(\.?_?\d+)+)/i, n);
          return t && (e.version = t), e;
        },
      },
      {
        ...
        describe(n) {
          const e = { name: "NAVER Whale Browser" },
            t =
              _.getFirstMatch(x, n) ||
              _.getFirstMatch(/(?:whale)[\s/](\d+(?:\.\d+)+)/i, n);
          return t && (e.version = t), e;
        },
      },
      {
        ...
        describe(n) {
          const e = { name: "MZ Browser" },
            t =
              _.getFirstMatch(/(?:MZBrowser)[\s/](\d+(?:\.\d+)+)/i, n) ||
              _.getFirstMatch(x, n);
          return t && (e.version = t), e;
        },
      },
      {
        ...
        describe(n) {
          const e = { name: "Focus" },
            t =
              _.getFirstMatch(/(?:focus)[\s/](\d+(?:\.\d+)+)/i, n) ||
              _.getFirstMatch(x, n);
          return t && (e.version = t), e;
        },
      },
      {
        ...
        describe(n) {
          const e = { name: "Swing" },
            t =
              _.getFirstMatch(/(?:swing)[\s/](\d+(?:\.\d+)+)/i, n) ||
              _.getFirstMatch(x, n);
          return t && (e.version = t), e;
        },
      },
      {
        ...
        describe(n) {
          const e = { name: "Opera Coast" },
            t =
              _.getFirstMatch(x, n) ||
              _.getFirstMatch(/(?:coast)[\s/](\d+(\.?_?\d+)+)/i, n);
          return t && (e.version = t), e;
        },
      },
      {
        ...
        describe(n) {
          const e = { name: "Opera Touch" },
            t =
              _.getFirstMatch(/(?:opt)[\s/](\d+(\.?_?\d+)+)/i, n) ||
              _.getFirstMatch(x, n);
          return t && (e.version = t), e;
        },
      },
      {
        ...
        describe(n) {
          const e = { name: "Yandex Browser" },
            t =
              _.getFirstMatch(/(?:yabrowser)[\s/](\d+(\.?_?\d+)+)/i, n) ||
              _.getFirstMatch(x, n);
          return t && (e.version = t), e;
        },
      },
      {
        ...
        describe(n) {
          const e = { name: "UC Browser" },
            t =
              _.getFirstMatch(x, n) ||
              _.getFirstMatch(/(?:ucbrowser)[\s/](\d+(\.?_?\d+)+)/i, n);
          return t && (e.version = t), e;
        },
      },
      {
        ...
        describe(n) {
          const e = { name: "Maxthon" },
            t =
              _.getFirstMatch(x, n) ||
              _.getFirstMatch(/(?:Maxthon|mxios)[\s/](\d+(\.?_?\d+)+)/i, n);
          return t && (e.version = t), e;
        },
      },
      {
        ...
        describe(n) {
          const e = { name: "Epiphany" },
            t =
              _.getFirstMatch(x, n) ||
              _.getFirstMatch(/(?:epiphany)[\s/](\d+(\.?_?\d+)+)/i, n);
          return t && (e.version = t), e;
        },
      },
      {
        ...
        describe(n) {
          const e = { name: "Puffin" },
            t =
              _.getFirstMatch(x, n) ||
              _.getFirstMatch(/(?:puffin)[\s/](\d+(\.?_?\d+)+)/i, n);
          return t && (e.version = t), e;
        },
      },
      {
        ...
        describe(n) {
          const e = { name: "Sleipnir" },
            t =
              _.getFirstMatch(x, n) ||
              _.getFirstMatch(/(?:sleipnir)[\s/](\d+(\.?_?\d+)+)/i, n);
          return t && (e.version = t), e;
        },
      },
      {
        ...
        describe(n) {
          const e = { name: "K-Meleon" },
            t =
              _.getFirstMatch(x, n) ||
              _.getFirstMatch(/(?:k-meleon)[\s/](\d+(\.?_?\d+)+)/i, n);
          return t && (e.version = t), e;
        },
      },
      {
        ...
        describe(n) {
          const e = { name: "WeChat" },
            t =
              _.getFirstMatch(/(?:micromessenger)[\s/](\d+(\.?_?\d+)+)/i, n) ||
              _.getFirstMatch(x, n);
          return t && (e.version = t), e;
        },
      },
      ...
      },
      {
        ...
        describe(n) {
          const e = { name: "BlackBerry" },
            t =
              _.getFirstMatch(x, n) ||
              _.getFirstMatch(/blackberry[\d]+\/(\d+(\.?_?\d+)+)/i, n);
          return t && (e.version = t), e;
        },
      },
      {
        ...
        describe(n) {
          const e = { name: "WebOS Browser" },
            t =
              _.getFirstMatch(x, n) ||
              _.getFirstMatch(/w(?:eb)?[o0]sbrowser\/(\d+(\.?_?\d+)+)/i, n);
          return t && (e.version = t), e;
        },
      },
      {
      ...
      },
      {
        ...
        describe(n) {
          const e = { name: "Tizen" },
            t =
              _.getFirstMatch(/(?:tizen\s?)?browser\/(\d+(\.?_?\d+)+)/i, n) ||
              _.getFirstMatch(x, n);
          return t && (e.version = t), e;
        },
      },
      {
        ...
        describe(n) {
          const e = { name: "QupZilla" },
            t =
              _.getFirstMatch(/(?:qupzilla)[\s/](\d+(\.?_?\d+)+)/i, n) ||
              _.getFirstMatch(x, n);
          return t && (e.version = t), e;
        },
      },
      ...
      },
      {
        ...
        describe(n) {
          const e = { name: "Chromium" },
            t =
              _.getFirstMatch(/(?:chromium)[\s/](\d+(\.?_?\d+)+)/i, n) ||
              _.getFirstMatch(x, n);
          return t && (e.version = t), e;
        },
      },
  ...
  var Qs = [
      ...
      },
      {
        test: [/macintosh/i],
        describe(n) {
          const e = _.getFirstMatch(/mac os x (\d+(\.?_?\d+)+)/i, n).replace(
              /[_\s]/g,
              "."
            ),
      ...
      },
      {
        ...
        describe(n) {
          const e =
            _.getFirstMatch(/rim\stablet\sos\s(\d+(\.\d+)*)/i, n) ||
            _.getFirstMatch(/blackberry\d+\/(\d+([_\s]\d+)*)/i, n) ||
            _.getFirstMatch(/\bbb(\d+)/i, n);
    ...
    Xs = [
      ...
      },
      {
        ...
        describe(n) {
          const e = _.getFirstMatch(/(can-l01)/i, n) && "Nova",
            t = { type: $.mobile, vendor: "Huawei" };
          return e && (t.model = e), t;
        },
      },
      {
        test: [/nexus\s*(?:7|8|9|10).*/i],
        describe: () => ({ type: $.tablet, vendor: "Nexus" }),
      },
      {
        test: [/ipad/i],
        describe: () => ({ type: $.tablet, vendor: "Apple", model: "iPad" }),
      },
      {
        test: [/Macintosh(.*?) FxiOS(.*?)\//],
        describe: () => ({ type: $.tablet, vendor: "Apple", model: "iPad" }),
      ...
      {
        test: [/silk/i],
        describe: () => ({ type: $.tablet, vendor: "Amazon" }),
      },
      { test: [/tablet(?! pc)/i], describe: () => ({ type: $.tablet }) },
      {
        test(n) {
      ...
      },
      {
        ...
        describe: () => ({ type: $.mobile, vendor: "Nexus" }),
      },
      { test: [/[^-]mobi/i], describe: () => ({ type: $.mobile }) },
      {
        test: (n) => n.getBrowserName(!0) === "blackberry",
        describe: () => ({ type: $.mobile, vendor: "BlackBerry" }),
      },
      {
        test: (n) => n.getBrowserName(!0) === "bada",
        describe: () => ({ type: $.mobile }),
      },
      {
        test: (n) => n.getBrowserName() === "windows phone",
        describe: () => ({ type: $.mobile, vendor: "Microsoft" }),
      },
      {
        test(n) {
      ...
      },
      {
        ...
        describe: () => ({ type: $.desktop, vendor: "Apple" }),
      },
      {
        test: (n) => n.getOSName(!0) === "windows",
        describe: () => ({ type: $.desktop }),
      },
      {
    ...
    compareVersion(e) {
      ...
      if (typeof s == "string")
        return (
          e[0] === ">" || e[0] === "<"
            ? ((r = e.substr(1)),
              e[1] === "=" ? ((i = !0), (r = e.substr(2))) : (t = []),
              e[0] === ">" ? t.push(1) : t.push(-1))
            : e[0] === "="
            ? (r = e.substr(1))
            : e[0] === "~" && ((i = !0), (r = e.substr(1))),
          t.indexOf(_.compareVersions(s, r, i)) > -1
        );
    }
    isOS(e) {
  ...
  function Lr(n, e) {
    return e != null && e.proxyUrl
      ? e.proxyUrl + (e.proxyUrl.slice(-1) === "/" ? "" : "/") + n.substring(8)
      : n;
  }
  function Ot(n) {
    return n != null && n.callObjectBundleUrlOverride
      ? n.callObjectBundleUrlOverride
      : Lr(
          "https://c.daily.co/call-machine/versioned/".concat(
            "0.66.0",
            "/static/call-machine-object-bundle.js"
          ),
          n
        );
  }
  ...
  function ta(n, e, t = !1) {
    return (
      !!Re(n) &&
      (ze(e, "RegExp") ? e.test(n) : !!Re(e) && (t ? n === e : n.includes(e)))
    );
  }
  function Pt(n, e = [], t = !1) {
  ...
  function na(n, e, t = 250, r, i, s, c) {
    ...
    l &&
      (s.exception.values =
        ((u = hn(n, e, i, c.originalException, r, s.exception.values, l, 0)),
        (h = t),
        u.map((p) => (p.value && (p.value = Ke(p.value, h)), p))));
  }
  ...
  const ne =
    (typeof globalThis == "object" && It(globalThis)) ||
    (typeof window == "object" && It(window)) ||
    (typeof self == "object" && It(self)) ||
    (typeof global == "object" && It(global)) ||
    (function () {
      return this;
    })() ||
    {};
  ...
  function fn(n, e = {}) {
    try {
      ...
      for (
        ...
        s++ < r &&
        ((h = oa(t, p)),
        !(h === "html" || (s > 1 && c + i.length * u + h.length >= m)));
  ...
  function oa(n, e) {
    ...
    const h =
      e && e.length
        ? e.filter((m) => t.getAttribute(m)).map((m) => [m, t.getAttribute(m)])
        : null;
    if (h && h.length)
      h.forEach((m) => {
        r.push(`[${m[0]}="${m[1]}"]`);
  ...
  let O;
  O =
    typeof __SENTRY_DEBUG__ > "u" || __SENTRY_DEBUG__ ? pn("logger", Br) : Br();
  const sa = /^(?:(\w+):)\/\/(?:(\w+)(?::(\w+)?)?@)([\w.-]+)(?::(\d+))?\/(.+)/;
  function Nt(n, e = !1) {
    const {
      host: t,
    ...
    const e =
      typeof n == "string"
        ? (function (t) {
            ...
            const y = m.split("/");
            if (
              (y.length > 1 && ((p = y.slice(0, -1).join("/")), (m = y.pop())),
              m)
            ) {
              const w = m.match(/^\d+/);
              w && (m = w[0]);
      ...
      (function (t) {
        ...
        return !(
          ["protocol", "publicKey", "host", "projectId"].find(
            (c) => !t[c] && (O.error(`Invalid Sentry Dsn: ${c} missing`), !0)
          ) ||
          (i.match(/^\d+$/)
            ? (function (c) {
              ...
              ? r &&
                isNaN(parseInt(r, 10)) &&
                (O.error(`Invalid Sentry Dsn: Invalid port ${r}`), 1)
              : (O.error(`Invalid Sentry Dsn: Invalid protocol ${s}`), 1)
  ...
  function Yr(n) {
    if (Ir(n))
      return { message: n.message, name: n.name, stack: n.stack, ...Gr(n) };
    if (Lt(n)) {
      const e = {
        type: n.type,
        target: $r(n.target),
      ...
      return (
        typeof CustomEvent < "u" && xe(n, CustomEvent) && (e.detail = n.detail),
        e
      );
    }
    return n;
  ...
  function yn(n) {
    return (
      n && /^function fetch\(\)\s+\{\s+\[native code\]\s+\}$/.test(n.toString())
    );
  }
  function ca() {
    if (
    ...
    if (e && typeof e.createElement == "function")
      try {
        ...
        (t.hidden = !0),
          ...
          t.contentWindow &&
            t.contentWindow.fetch &&
            (n = yn(t.contentWindow.fetch)),
    ...
    if (!Jr[n])
      switch (((Jr[n] = !0), n)) {
          ...
          (function () {
            "console" in B &&
              Dt.forEach(function (e) {
                e in B.console &&
                  W(B.console, e, function (t) {
                    return function (...r) {
                      ue("console", { args: r, level: e }),
            ...
            B.document.addEventListener("click", t, !1),
              ...
              ["EventTarget", "Node"].forEach((r) => {
                ...
                i &&
                  ...
                  (W(i, "addEventListener", function (s) {
                      ...
                      if (c === "click" || c == "keypress")
                        try {
                          ...
                          m &&
                            (m.refCount--,
                            m.refCount <= 0 &&
                              (s.call(this, c, m.handler, u),
                              (m.handler = void 0),
                              delete p[c]),
                            Object.keys(p).length === 0 &&
                              delete h.__sentry_instrumentation_handlers__);
                        } catch {}
                      return s.call(this, c, l, u);
                    };
                  }));
                  ...
                  W(this, "setRequestHeader", function (l) {
                    return function (...u) {
                      const [h, p] = u,
                        m = this[ht];
                      return (
                        m && (m.request_headers[h.toLowerCase()] = p),
                        l.apply(this, u)
                      );
                    };
                  }),
          ...
          (function () {
            ...
            (B.onpopstate = function (...r) {
              const i = B.location.href,
                s = jt;
              if (((jt = i), ue("history", { from: s, to: i }), e))
                try {
                  return e.apply(this, r);
                } catch {}
            }),
              W(B.history, "pushState", t),
              W(B.history, "replaceState", t);
          })();
          break;
        case "error":
          (Bt = B.onerror),
            (B.onerror = function (e, t, r, i, s) {
              return (
                ue("error", { column: i, error: s, line: r, msg: e, url: t }),
        ...
        default:
          return void (
            (typeof __SENTRY_DEBUG__ > "u" || __SENTRY_DEBUG__) &&
            O.warn("unknown instrumentation type:", n)
          );
      }
  }
  function je(n, e) {
...
Error:`,
  ...
  function zr(n, e = !1) {
    return (t) => {
      ...
      (Ft === void 0 ||
        ...
        (n({ event: t, name: r, global: e }), (Sn = t)),
        clearTimeout(Ft),
        (Ft = B.setTimeout(() => {
          Ft = void 0;
        }, ua));
  ...
  function ft(n, e) {
    ...
    const r = t.mechanism;
    if (
      ((t.mechanism = { type: "generic", handled: !0, ...r, ...e }),
      e && "data" in e)
    ) {
  ...
  class Z {
    ...
    constructor(e) {
      Z.prototype.__init.call(this),
        Z.prototype.__init2.call(this),
        Z.prototype.__init3.call(this),
        Z.prototype.__init4.call(this),
        Z.prototype.__init5.call(this),
        Z.prototype.__init6.call(this);
      try {
    ...
    __init6() {
      this._executeHandlers = () => {
        ...
        (this._handlers = []),
          e.forEach((t) => {
            t[0] ||
              (this._state === be.RESOLVED && t[1](this._value),
              this._state === be.REJECTED && t[2](this._value),
              (t[0] = !0));
          });
      };
    }
    ...
    return {
      ...
      add: function (r) {
        if (!(n === void 0 || e.length < n))
          return Vt(
            new le("Not adding Promise because buffer limit was reached.")
          );
        const i = r();
        return (
          e.indexOf(i) === -1 && e.push(i),
          i.then(() => t(i)).then(null, () => t(i).then(null, () => {})),
          i
        );
      },
      drain: function (r) {
  ...
  const ha = ["fatal", "error", "warning", "log", "info", "debug"],
    ...
    Cn =
      ...
      Object.prototype.toString.call(typeof process < "u" ? process : 0) !==
        "[object process]"
        ? (function () {
            const { performance: n } = Xr;
            if (!(!n || !n.now))
              return { now: () => n.now(), timeOrigin: Date.now() - n.now() };
          })()
        : (function () {
            try {
              return ((n = module), (e = "perf_hooks"), n.require(e))
                .performance;
            } catch {
              return;
            }
  ...
  function fa(n, e) {
    ...
    function s(c) {
      typeof i == "string"
        ? (i = typeof c == "string" ? i + c : [Mn(i, e), c])
        : i.push(typeof c == "string" ? Mn(c, e) : c);
    }
    for (const c of r) {
      const [l, u] = c;
      if (
...
`),
  ...
  const va = 6e4;
  function _a(n, { statusCode: e, headers: t }, r = Date.now()) {
    const i = { ...n },
  ...
  function Qe(n, e = {}) {
    if (
      ...
      (n.timestamp = e.timestamp || ei()),
      e.ignoreDuration && (n.ignoreDuration = e.ignoreDuration),
      e.sid && (n.sid = e.sid.length === 32 ? e.sid : Me()),
  ...
  class Be {
    ...
    setUser(e) {
      return (
        (this._user = e || {}),
        this._session && Qe(this._session, { user: e }),
      ...
      return new Z((s, c) => {
        ...
        if (t === null || typeof l != "function") s(t);
          ...
          (typeof __SENTRY_DEBUG__ > "u" || __SENTRY_DEBUG__) &&
            l.id &&
            u === null &&
            O.log(`Event processor "${l.id}" dropped event`),
            dn(u)
              ? u
                  .then((h) =>
                    this._notifyEventProcessors(e, h, r, i + 1).then(s)
                  )
                  .then(null, c)
  ...
  class On {
    ...
    captureException(e, t) {
      ...
      return (
        this._withClient((s, c) => {
          s.captureException(
            e,
            { originalException: e, syntheticException: i, ...t, event_id: r },
            c
          );
        }),
        r
    ...
    addBreadcrumb(e, t) {
      ...
      if (!i) return;
      const { beforeBreadcrumb: s = null, maxBreadcrumbs: c = ba } =
        (i.getOptions && i.getOptions()) || {};
      if (c <= 0) return;
      const l = { timestamp: Yt(), ...e },
        u = s ? Fr(() => s(l, t)) : l;
      u !== null &&
        (i.emit && i.emit("beforeAddBreadcrumb", u, t), r.addBreadcrumb(u, c));
    }
    setUser(e) {
    ...
    getIntegration(e) {
      ...
      try {
        ...
        return (
          (typeof __SENTRY_DEBUG__ > "u" || __SENTRY_DEBUG__) &&
            O.warn(`Cannot retrieve integration ${e.id} from the current Hub`),
          null
        );
      }
    }
...
`),
    ...
    startSession(e) {
      const { scope: t, client: r } = this.getStackTop(),
        { release: i, environment: s = An } = (r && r.getOptions()) || {},
        { userAgent: c } = ne.navigator || {},
        l = ya({
          release: i,
          environment: s,
          user: t.getUser(),
      ...
      return (
        u && u.status === "ok" && Qe(u, { status: "exited" }),
        this.endSession(),
        t.setSession(l),
        l
      );
  ...
  function $t() {
    return (
      (ne.__SENTRY__ = ne.__SENTRY__ || { extensions: {}, hub: void 0 }), ne
    );
  }
  function ci(n) {
    const e = $t(),
  ...
  function ee() {
    ...
    return (function (e = $t()) {
      (t = e),
        (t && t.__SENTRY__ && t.__SENTRY__.hub && !Ln(e).isOlderThan(ai)) ||
          li(e, new On());
      var t;
      return Ln(e);
    })(n);
  ...
  function Ea(n, e, t, r) {
    ...
    (function (l, u) {
      u &&
        ((l.sdk = l.sdk || {}),
        (l.sdk.name = l.sdk.name || u.name),
        (l.sdk.version = l.sdk.version || u.version),
        (l.sdk.integrations = [
          ...(l.sdk.integrations || []),
          ...(u.integrations || []),
        ]),
        (l.sdk.packages = [...(l.sdk.packages || []), ...(u.packages || [])]));
    })(n, t && t.sdk);
    ...
    return delete n.sdkProcessingMetadata, mt(c, [[{ type: s }, n]]);
  }
  const ui = [];
  function di(n, e) {
    (e[n.name] = n),
      ui.indexOf(n.name) === -1 &&
        ...
        ui.push(n.name),
        (typeof __SENTRY_DEBUG__ > "u" || __SENTRY_DEBUG__) &&
          O.log(`Integration installed: ${n.name}`));
  }
  function ka(n, e, t, r) {
    const { normalizeDepth: i = 3, normalizeMaxBreadth: s = 1e3 } = n,
      c = {
        ...e,
    ...
    (function (p, m) {
      ...
      "environment" in p || (p.environment = "environment" in m ? y : An),
        p.release === void 0 && w !== void 0 && (p.release = w),
        p.dist === void 0 && b !== void 0 && (p.dist = b),
        p.message && (p.message = Ke(p.message, S));
      ...
      (function (p, m) {
        m.length > 0 &&
          ((p.sdk = p.sdk || {}),
          (p.sdk.integrations = [...(p.sdk.integrations || []), ...m]));
      })(c, l),
      e.type === void 0 &&
        (function (p, m) {
            ...
            try {
              m.exception.values.forEach((b) => {
                b.stacktrace.frames.forEach((S) => {
                  S.debug_id &&
                    (S.abs_path
                      ? (y[S.abs_path] = S.debug_id)
                      : S.filename && (y[S.filename] = S.debug_id),
                    delete S.debug_id);
                });
              });
            } catch {}
              ...
              const b = {
                ...
                ...(m.breadcrumbs && {
                  breadcrumbs: m.breadcrumbs.map((S) => ({
                    ...S,
                    ...(S.data && { data: Oe(S.data, y, w) }),
                  })),
                }),
                ...(m.user && { user: Oe(m.user, y, w) }),
                ...(m.contexts && { contexts: Oe(m.contexts, y, w) }),
                ...(m.extra && { extra: Oe(m.extra, y, w) }),
              };
              return (
                m.contexts &&
                  m.contexts.trace &&
                  b.contexts &&
                  ((b.contexts.trace = m.contexts.trace),
                  m.contexts.trace.data &&
                    (b.contexts.trace.data = Oe(m.contexts.trace.data, y, w))),
                m.spans &&
                  (b.spans = m.spans.map(
                    (S) => (S.data && (S.data = Oe(S.data, y, w)), S)
                  )),
                b
              );
            })(p, i, s)
  ...
  class Ue {
    ...
    constructor(e) {
      if (
        ...
        e.dsn
          ? (this._dsn = aa(e.dsn))
          : (typeof __SENTRY_DEBUG__ > "u" || __SENTRY_DEBUG__) &&
            O.warn("No DSN provided, client will not do anything."),
        this._dsn)
      ) {
      ...
      return (
        this._process(
          this.eventFromException(e, t)
            .then((s) => this._captureEvent(s, t, r))
            .then((s) => {
              i = s;
            })
        ),
    ...
    captureMessage(e, t, r, i) {
      let s = r && r.event_id;
      const c = Nr(e)
        ? this.eventFromMessage(String(e), t, r)
    ...
    captureEvent(e, t, r) {
      ...
      return (
        this._process(
          this._captureEvent(e, t, r).then((s) => {
            i = s;
          })
        ),
        i
    ...
    captureSession(e) {
      this._isEnabled()
        ? typeof e.release != "string"
          ? (typeof __SENTRY_DEBUG__ > "u" || __SENTRY_DEBUG__) &&
            O.warn("Discarded session because of missing or non-string release")
          : (this.sendSession(e), Qe(e, { init: !1 }))
        : (typeof __SENTRY_DEBUG__ > "u" || __SENTRY_DEBUG__) &&
          O.warn("SDK not enabled, will not capture session.");
    }
    getDsn() {
      return this._dsn;
    }
      ...
      return (
        ...
        ka(i, e, t, r).then((c) => {
          ...
          if (!(c.contexts && c.contexts.trace) && l) {
            ...
            c.contexts = {
              trace: { trace_id: u, span_id: h, parent_span_id: p },
              ...c.contexts,
            };
            const y =
              m ||
    ...
    _processEvent(e, t, r) {
      const i = this.getOptions(),
        { sampleRate: s } = i;
      if (!this._isEnabled())
        return Vt(new le("SDK not enabled, will not capture event.", "log"));
      const c = mi(e),
        l = fi(e),
        u = e.type || "error",
      ...
      return this._prepareEvent(e, t, r)
        .then((m) => {
          if (m === null)
            throw (
              (this.recordDroppedEvent("event_processor", p, e),
              new le(
          ...
          const y = (function (w, b, S) {
            const { beforeSend: T, beforeSendTransaction: L } = w;
        ...
        .then((m) => {
          if (m === null)
            throw (
              (this.recordDroppedEvent("before_send", p, e),
              new le(`${h} returned \`null\`, will not send event.`, "log"))
            );
...
Reason: ${m}`));
  ...
  function Ca(n, e, t = da(n.bufferSize || Ta)) {
    ...
    function i(s) {
      ...
      return t
        .add(() =>
          e({ body: fa(l, n.textEncoder) }).then(
            (h) => (
              h.statusCode !== void 0 &&
        ...
        .then(
          ...
          (h) => {
            if (h instanceof le)
              return (
                (typeof __SENTRY_DEBUG__ > "u" || __SENTRY_DEBUG__) &&
                  O.error("Skipped sending event because buffer is full."),
                u("queue_overflow"),
                Fe()
              );
            throw h;
    ...
    return (
      (i.__sentry__baseTransport__ = !0), { send: i, flush: (s) => t.drain(s) }
    );
  }
  function gi(n, e) {
              ...
              h = (function (p = {}, m = {}) {
                return {
                  ...
                  ignoreErrors: [
                    ...(p.ignoreErrors || []),
                    ...(m.ignoreErrors || []),
                    ...(p.disableErrorDefaults ? [] : Ma),
                  ],
                  ignoreTransactions: [
                    ...(p.ignoreTransactions || []),
                    ...(m.ignoreTransactions || []),
                    ...(p.disableTransactionDefaults ? [] : Aa),
                  ],
                  ignoreInternal:
                    p.ignoreInternal === void 0 || p.ignoreInternal,
                };
              })(c._options, u);
            return (function (p, m) {
                            ...
                            try {
                              ...
                              return (
                                (typeof __SENTRY_DEBUG__ > "u" ||
                                  __SENTRY_DEBUG__) &&
                                  O.error(
                                    `Cannot extract message for event ${Ae(b)}`
                                  ),
                                []
                              );
                            }
...
Url: ${Gt(p)}`),
  ...
  function Gt(n) {
    try {
      ...
      return (
        (typeof __SENTRY_DEBUG__ > "u" || __SENTRY_DEBUG__) &&
          O.error(`Cannot extract url for event ${Ae(n)}`),
        null
      );
    }
  }
  ...
  function Ze(n, e = {}, t) {
      ...
      try {
        ...
        throw (
          ...
          (s = (l) => {
            ...
            l.addEventProcessor(
              (p) => (
                e.mechanism && (wn(p, void 0, void 0), ft(p, e.mechanism)),
                (p.extra = { ...p.extra, arguments: i }),
                p
              )
            ),
              (u = c),
              ee().captureException(u, { captureContext: h });
          }),
          ee().withScope(s),
          c)
        );
    ...
    try {
      Object.getOwnPropertyDescriptor(r, "name").configurable &&
        Object.defineProperty(r, "name", { get: () => n.name });
    } catch {}
    return r;
  }
  function bi(n, e) {
    const t = Dn(n, e),
      r = { type: e && e.name, value: Pa(e) };
    return (
  ...
  function In(n, e) {
    return { exception: { values: [bi(n, e)] } };
  }
  function Dn(n, e) {
  ...
  function Nn(n, e, t, r, i) {
    ...
    if (Dr(e) || ze(e, "DOMException")) {
      ...
      return (
        "code" in c &&
          (s.tags = { ...s.tags, "DOMException.code": `${c.code}` }),
        s
      );
    }
    return Ir(e)
                ...
                values: [
                  {
                    type: Lt(l)
                      ...
                      ? "UnhandledRejection"
                      : "Error",
                    value: Ia(l, { isUnhandledRejection: h }),
                  },
                ],
              },
              extra: { __serialized__: Qr(l, m) },
            };
          if (u) {
            const w = Dn(c, u);
  ...
  function Ia(n, { isUnhandledRejection: e }) {
  ...
  class vt {
    ...
    setupOnce() {
      this.options.console && je("console", Da),
        this.options.dom &&
          je(
            "dom",
            (function (e) {
              function t(r) {
                ...
                c &&
                  ...
                  ((typeof __SENTRY_DEBUG__ > "u" || __SENTRY_DEBUG__) &&
                    O.warn(
                      `\`dom.maxStringLength\` cannot exceed 1024, but a value of ${c} was configured. Sentry will use 1024 instead.`
                    ),
                  (c = Si)),
                  typeof s == "string" && (s = [s]);
                try {
                  ...
                  i = (function (u) {
                    ...
                    ? fn(l.target, { keyAttrs: s, maxStringLength: c })
                    : fn(l, { keyAttrs: s, maxStringLength: c });
                } catch {
                  i = "<unknown>";
                }
                i.length !== 0 &&
                  ee().addBreadcrumb(
                    { category: `ui.${r.name}`, message: i },
        ...
        this.options.xhr && je("xhr", Na),
        this.options.fetch && je("fetch", Ra),
        this.options.history && je("history", xa);
    }
    addSentryBreadcrumb(e) {
      this.options.sentry &&
        ee().addBreadcrumb(
          {
            category:
              "sentry." + (e.type === "transaction" ? "transaction" : "event"),
            event_id: e.event_id,
            level: e.level,
            message: Ae(e),
          },
  ...
  function Da(n) {
    ...
    const e = {
      ...
      level:
        ((t = n.level), t === "warn" ? "warning" : ha.includes(t) ? t : "log"),
      message: Rr(n.args, " "),
    };
    var t;
    if (n.level === "assert") {
      ...
      (e.message = `Assertion failed: ${
        Rr(n.args.slice(1), " ") || "console.assert"
      }`),
  ...
  function Na(n) {
    const { startTimestamp: e, endTimestamp: t } = n,
      r = n.xhr[ht];
    if (!e || !t || !r) return;
    const { method: i, url: s, status_code: c, body: l } = r,
      u = { method: i, url: s, status_code: c },
  ...
  function xa(n) {
    ...
    i.path || (i = r),
      ...
      ee().addBreadcrumb({ category: "navigation", data: { from: e, to: t } });
  }
  vt.__initStatic();
  class ja extends Ue {
    constructor(e) {
      ...
      (e._metadata = e._metadata || {}),
        (e._metadata.sdk = e._metadata.sdk || {
          ...
          packages: [{ name: `${t}:@sentry/browser`, version: vi }],
          version: vi,
        }),
        super(e),
        e.sendClientReports &&
    ...
    eventFromException(e, t) {
      return (function (r, i, s, c) {
        ...
        return (
          ft(l),
          (l.level = "error"),
          s && s.event_id && (l.event_id = s.event_id),
          Fe(l)
        );
    ...
    eventFromMessage(e, t = "info", r) {
      return (function (i, s, c = "info", l, u) {
        ...
        return (
          (h.level = c), l && l.event_id && (h.event_id = l.event_id), Fe(h)
        );
    ...
    captureUserFeedback(e) {
      if (!this._isEnabled())
        return void (
          (typeof __SENTRY_DEBUG__ > "u" || __SENTRY_DEBUG__) &&
          O.warn("SDK not enabled, will not capture user feedback.")
        );
      const t = (function (r, { metadata: i, tunnel: s, dsn: c }) {
        const l = {
          ...
          sent_at: new Date().toISOString(),
          ...(i &&
            i.sdk && { sdk: { name: i.sdk.name, version: i.sdk.version } }),
          ...(!!s && !!c && { dsn: Nt(c) }),
        };
        return mt(l, [
          (function (h) {
    ...
    _prepareEvent(e, t, r) {
      return (
        (e.platform = e.platform || "javascript"), super._prepareEvent(e, t, r)
      );
    }
    _flushOutcomes() {
      ...
      if (e.length === 0)
        return void (
          (typeof __SENTRY_DEBUG__ > "u" || __SENTRY_DEBUG__) &&
          O.log("No outcomes to send")
        );
      if (!this._dsn)
        return void (
          (typeof __SENTRY_DEBUG__ > "u" || __SENTRY_DEBUG__) &&
          O.log("No dsn provided, will not send outcomes")
        );
      (typeof __SENTRY_DEBUG__ > "u" || __SENTRY_DEBUG__) &&
        O.log("Sending outcomes:", e);
      const t =
        ((r = e),
        mt((i = this._options.tunnel && Nt(this._dsn)) ? { dsn: i } : {}, [
          [
            { type: "client_report" },
            { timestamp: s || Yt(), discarded_events: r },
          ],
        ]));
      var r, i, s;
      this._sendEnvelope(t);
  ...
  class Le {
    ...
    __init2() {
      this._installFunc = { onerror: Ba, onunhandledrejection: Ua };
    }
    constructor(e) {
    ...
    setupOnce() {
      ...
      for (const r in e) {
        ...
        i &&
          ...
          ((t = r),
          (typeof __SENTRY_DEBUG__ > "u" || __SENTRY_DEBUG__) &&
            O.log(`Global Handler attached: ${t}`),
          i(),
      ...
      const h =
        u === void 0 && Re(i)
          ? (function (p, m, y, w) {
              ...
              return (
                L && ((T = L[1]), (S = L[2])),
                Ei({ exception: { values: [{ type: T, value: S }] } }, m, y, w)
              );
            })(i, s, c, l)
          : Ei(Nn(t, u || i, void 0, r, !1), s, c, l);
  ...
  function Ua() {
    je("unhandledrejection", (n) => {
      ...
      try {
        "reason" in n
          ? (i = n.reason)
          : "detail" in n && "reason" in n.detail && (i = n.detail.reason);
      } catch {}
  ...
  function Ei(n, e, t, r) {
    ...
    return (
      u.length === 0 &&
        u.push({ colno: h, filename: m, function: "?", in_app: !0, lineno: p }),
      n
    );
  }
  function ki(n, e, t, r) {
    ft(t, { handled: !1, type: r }),
      n.captureEvent(t, { originalException: e });
  }
  function Ti() {
    const n = ee(),
      e = n.getClient(),
  ...
  class yt {
    ...
    setupOnce() {
      this._options.setTimeout && W(F, "setTimeout", Ci),
        this._options.setInterval && W(F, "setInterval", Ci),
        this._options.requestAnimationFrame &&
          W(F, "requestAnimationFrame", Ya),
        this._options.XMLHttpRequest &&
          "XMLHttpRequest" in F &&
          W(XMLHttpRequest.prototype, "send", $a);
  ...
  function Ya(n) {
    return function (e) {
      return n.apply(this, [
        Ze(e, {
          mechanism: {
            data: { function: "requestAnimationFrame", handler: Ce(n) },
            handled: !0,
            type: "instrument",
          },
        }),
        ...
        return function (i, s, c) {
          try {
            typeof s.handleEvent == "function" &&
              (s.handleEvent = Ze(s.handleEvent, {
                mechanism: {
                  data: { function: "handleEvent", handler: Ce(s), target: n },
                  handled: !0,
                  type: "instrument",
                },
              }));
  ...
  class et {
    ...
    setupOnce(e, t) {
      e((r, i) => {
        ...
        return (
          na(bi, u.stackParser, u.maxValueLength, l._key, l._limit, r, i), r
        );
      });
    }
  }
    ...
    setupOnce() {
      oi((e) => {
        if (ee().getIntegration(tt)) {
          ...
          const t =
              (e.request && e.request.url) || (F.location && F.location.href),
            { referrer: r } = F.document || {},
            { userAgent: i } = F.navigator || {},
            s = {
              ...(e.request && e.request.headers),
              ...(r && { Referer: r }),
              ...(i && { "User-Agent": i }),
            },
            c = { ...e.request, ...(t && { url: t }), headers: s };
          return { ...e, request: c };
        }
        return e;
      });
  ...
  var xn = "new",
    ...
    Do = { NONE: "none", NOISE_CANCELLATION: "noise-cancellation" },
        ...
        switch (n) {
          ...
          case "Safari":
            return (
              ...
              !(e.major === 13 && e.minor === 0 && e.point === 0)
            );
          case "Firefox":
            return e.major >= 67;
        }
      ...
      (n
        ...
        : (function () {
            ...
            return e === "Chrome"
              ...
              : e === "Firefox"
              ? Kn().major >= 97
              : ["Chrome", "Firefox", "Safari"].includes(e);
          })())
    );
  }
    ...
    var n,
      ...
      r =
        ...
        e.maxTouchPoints
          ...
          : 0) >= 5;
    return (
      !!(t.match(/Mobi/) || t.match(/Android/) || r) ||
      !!de().match(/DailyAnd\//) ||
      void 0
    );
  }
  function Pe() {
    if (typeof window < "u") {
      ...
      return Uo()
        ...
        : n.indexOf("Firefox") > -1
        ? "Firefox"
        : n.indexOf("MSIE") > -1 || n.indexOf(".NET") > -1
        ? "IE"
        : "Unknown Browser";
    }
  }
  ...
  var Tc = (function (n) {
    ...
    function t() {
      ...
      return (
        se(this, t),
        ((r = e.call(this))._wrappedListeners = {}),
        (r._messageCallbacks = {}),
        r
      );
    }
          ...
          value: function (r, i, s) {
            var c = this,
              l = function (u) {
                if (
                  u.data &&
                  u.data.what === "iframe-call-message" &&
                  (!u.data.callFrameId || u.data.callFrameId === i) &&
                  (!u.data.from || u.data.from !== "module")
                ) {
                  var h = Qn({}, u.data);
                  if (
                    (delete h.from,
                    h.callbackStamp && c._messageCallbacks[h.callbackStamp])
                  ) {
                    var p = h.callbackStamp;
                    c._messageCallbacks[p].call(s, h),
                      delete c._messageCallbacks[p];
                  }
                  delete h.what, delete h.callbackStamp, r.call(s, h);
                }
              };
            (this._wrappedListeners[r] = l),
            ...
            var c = function (l) {
              if (
                !(
                  ...
                  l.data.what !== $n ||
                  !l.data.action ||
                  (l.data.from && l.data.from !== "module") ||
                  (l.data.callFrameId && i && l.data.callFrameId !== i)
                )
              ) {
                var u = l.data;
                r.call(s, u);
        ...
        },
        {
          ...
          value: function (r, i) {
            (r.what = $n),
              (r.callFrameId = i),
              (r.from = "embedded"),
              window.postMessage(r, this._targetOriginFromWindowLocation());
          },
        },
        {
          key: "removeListener",
          ...
          value: function (r) {
            return r
              ? r.src
                ...
                : void 0
              : this._targetOriginFromWindowLocation();
          },
        },
        {
      ...
      function t() {
        ...
        return (
          ...
          (global.callMachineToDailyJsEmitter =
            global.callMachineToDailyJsEmitter || new ye.EventEmitter()),
          (global.dailyJsToCallMachineEmitter =
            global.dailyJsToCallMachineEmitter || new ye.EventEmitter()),
          (r._wrappedListeners = {}),
          (r._messageCallbacks = {}),
          r
        );
              ...
              var l = this,
                u = function (h) {
                  if (h.callbackStamp && l._messageCallbacks[h.callbackStamp]) {
                    var p = h.callbackStamp;
                    l._messageCallbacks[p].call(s, h),
                      delete l._messageCallbacks[p];
                  }
                  r.call(s, h);
                };
          ...
          [
            ...
            },
            {
              ...
              value: function (e) {
                if (!$o.includes(e))
                  throw Error(
                    "Unrecognized mergeStrategy provided. Options are: [".concat(
                      $o,
                      "]"
                    )
                  );
            ...
            },
            {
              ...
              value: function (e, t) {
                if (
                  ...
                  throw Error(
                    "Meeting session data must be a plain (map-like) object"
                  );
                var r;
                try {
                  ...
                  throw Error(
                    "Meeting session data must be serializable to JSON: ".concat(
                      l
                    )
                  );
                }
                if (r.length > Lo)
                  throw Error(
                    "Meeting session data is too large ("
                      .concat(
                        r.length,
                        " characters). Maximum size suppported is "
                      )
                      .concat(Lo, ".")
                  );
              },
  ...
  function tr(n) {
    ...
    return (
      (tr = function (t) {
        if (
          t === null ||
          ((r = t), Function.toString.call(r).indexOf("[native code]") === -1)
        )
          return t;
        var r;
  ...
  function Go(n) {
    var e,
      t = (e = window._daily) === null || e === void 0 ? void 0 : e.pendings;
    if (t) {
      var r = t.indexOf(n);
      r !== -1 && t.splice(r, 1);
    }
  ...
  var Lc = (function () {
      ...
      function n(t, r, i) {
        se(this, n),
          (this._loadAttemptImpl =
            N() || !t.avoidEval ? new Ic(t, r, i) : new Dc(t, r, i));
      }
      var e;
      return (
        ae(n, [
    ...
    Ic = (function () {
      function n(s, c, l) {
        se(this, n),
          ...
          (this._dailyConfig = s),
          (this._successCallback = c),
          (this._failureCallback = l);
      }
      var e, t, r, i;
      return (
        ae(n, [
          {
            ...
            value:
              ((i = C(function* () {
                ...
                !(yield this._tryLoadFromIOSCache(s)) &&
                  this._loadFromNetwork(s);
              })),
              function () {
              ...
              ((r = C(function* (s) {
                ...
                try {
                  ...
                  return (
                    ...
                    (!!c &&
                      (c.code
                        ? (Function('"use strict";' + c.code)(),
                          (this.succeeded = !0),
                          this._successCallback(),
                          !0)
                        : ((this._refetchHeaders = c.refetchHeaders), !1)))
                  );
                } catch {
                  return !1;
                }
            ...
            value:
              ((t = C(function* (s) {
                ...
                this._networkTimeout = setTimeout(function () {
                  (c._networkTimedOut = !0),
                    c._failureCallback({
                      msg: "Timed out (>"
                        .concat(Zt, " ms) when loading call object bundle ")
                        .concat(s),
                      type: "timeout",
                    });
                }, Zt);
                try {
                  ...
                  Function('"use strict";' + h)(),
                    this._iosCache && this._iosCache.set(s, h, u.headers),
                    (this.succeeded = !0),
                    this._successCallback();
                } catch (p) {
                  if (
                    (clearTimeout(this._networkTimeout),
                    p instanceof nr || this.cancelled || this._networkTimedOut)
                  )
                    return;
        ...
        ae(n, [
          {
            ...
            value: function () {
              ...
              (typeof document > "u" ? "undefined" : j(document)) === "object"
    ...
    Nc = function (n, e, t) {
      return (
        n.local.streams &&
        n.local.streams[e] &&
        n.local.streams[e].stream &&
        n.local.streams[e].stream[
          "get".concat(t === "video" ? "Video" : "Audio", "Tracks")
        ]()[0]
      );
    },
    rt = function (n, e, t, r) {
    ...
    Rc = function (n, e, t) {
      ...
      return i && i[e]
        ? [
            ...
            "rmpAudio",
            "rmpVideo",
          ].indexOf(t) === -1 && i[e].custom
          ? [!0, "staged"].includes(i[e].custom)
            ? r(i[e].custom)
            : r(i[e].custom[t])
          : r(i[e][t])
        : !i || r(i.ALL);
      ...
      for (var s = i[r], c = 0, l = ["video", "audio"]; c < l.length; c++) {
        var u = l[c],
          h =
            s === "cam"
              ? u
              : "screen".concat(u.charAt(0).toUpperCase() + u.slice(1)),
          p = n.tracks[h];
        if (p) {
        ...
        if (!Fc(r)) {
          ...
          if (i) {
            ...
            if (s) {
              ...
              s.state === "playable" && (n.tracks[r].track = c),
                (s.persistentTrack = c);
            }
  ...
  function zo(n, e, t) {
    ...
    if (n.local) {
      if (n.audio)
        try {
          (n.audioTrack = r.local.streams.cam.stream.getAudioTracks()[0]),
            n.audioTrack || (n.audio = !1);
        } catch {}
      if (n.video)
        try {
          (n.videoTrack = r.local.streams.cam.stream.getVideoTracks()[0]),
            n.videoTrack || (n.video = !1);
        } catch {}
      if (n.screen)
        try {
          (n.screenVideoTrack =
      ...
      try {
        ...
        s &&
          s.public &&
          s.public.rtcType &&
          s.public.rtcType.impl === "peer-to-peer" &&
          s.private &&
          !["connected", "completed"].includes(s.private.peeringState) &&
          (i = !1);
      } catch (p) {
        console.error(p);
      }
      if (!i)
        return (
          ...
          (n.videoTrack = !1),
          (n.screen = !1),
          void (n.screenTrack = !1)
        );
      try {
        if ((r.streams, n.audio && en(r, n.session_id, "cam-audio"))) {
          var c = rt(r, n.session_id, "cam", "audio");
          c &&
            (e && e.audioTrack && e.audioTrack.id === c.id
              ? (n.audioTrack = c)
              : c.muted || (n.audioTrack = c)),
            n.audioTrack || (n.audio = !1);
        }
        if (n.video && en(r, n.session_id, "cam-video")) {
          var l = rt(r, n.session_id, "cam", "video");
          l &&
            (e && e.videoTrack && e.videoTrack.id === l.id
              ? (n.videoTrack = l)
              : l.muted || (n.videoTrack = l)),
            n.videoTrack || (n.video = !1);
        }
        if (n.screen && en(r, n.session_id, "screen-audio")) {
          var u = rt(r, n.session_id, "screen", "audio");
          u &&
            (e && e.screenAudioTrack && e.screenAudioTrack.id === u.id
              ? (n.screenAudioTrack = u)
              : u.muted || (n.screenAudioTrack = u));
        }
        if (n.screen && en(r, n.session_id, "screen-video")) {
          var h = rt(r, n.session_id, "screen", "video");
          h &&
            (e && e.screenVideoTrack && e.screenVideoTrack.id === h.id
              ? (n.screenVideoTrack = h)
              : h.muted || (n.screenVideoTrack = h));
        }
        n.screenVideoTrack || n.screenAudioTrack || (n.screen = !1);
      } catch (p) {
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
                      ...
                      var r = C(function* () {
                        ...
                        try {
                          for (c.s(); !(i = c.n()).done; ) {
                            var l = i.value,
                              u = JSON.stringify(s);
                            u !== he.get(l).lastDevicesString &&
                              ((he.get(l).lastDevicesString = u), l(s));
                          }
                        } catch (h) {
                          c.e(h);
                        } finally {
                    ...
                    C(function* () {
                      ...
                      try {
                        for (s.s(); !(r = s.n()).done; ) {
                          var c = r.value,
                            l = JSON.stringify(i);
                          l !== pe.get(c).lastDevicesString &&
                            ((pe.get(c).lastDevicesString = l), c(i));
                        }
                      } catch (u) {
                        s.e(u);
                      } finally {
    ...
    Qo()
      ? (function (e) {
          he.has(e) &&
            ...
            he.size === 0 &&
              it &&
              (navigator.mediaDevices.removeEventListener("devicechange", it),
              (it = null)));
        })(n)
      : (function (e) {
          pe.has(e) &&
            (pe.delete(e),
            pe.size === 0 && wt && (clearInterval(wt), (wt = null)));
        })(n);
  }
  function Qo() {
  ...
  function qc(n, e) {
    ...
    return (
      ...
      !(function (r, i) {
        return (
          (!i.isLocalScreenVideo || Pe() !== "Chrome") &&
          r.muted &&
          !Gc.has(r.id)
        );
  ...
  function A(n) {
    for (var e = 1; e < arguments.length; e++) {
      var t = arguments[e] != null ? arguments[e] : {};
      e % 2
        ? Xo(Object(t), !0).forEach(function (r) {
            ke(n, r, t[r]);
          })
        : Object.getOwnPropertyDescriptors
        ? Object.defineProperties(n, Object.getOwnPropertyDescriptors(t))
        : Xo(Object(t)).forEach(function (r) {
            Object.defineProperty(n, r, Object.getOwnPropertyDescriptor(t, r));
          });
    }
    return n;
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
  ...
  var ts = "video",
    Kc = "voice",
    ns = N() ? { data: {} } : { data: {}, topology: "none" },
    rs = { present: 0, hidden: 0 },
    is = {
    ...
    Ge = {
      customIntegrations: { validate: ms, help: ps() },
      customTrayButtons: {
        validate: fs,
        ...
        validate: function (n, e) {
          return (
            n instanceof MediaStreamTrack &&
              (e._sharedTracks.videoDeviceId = n),
            (e._preloadCache.videoDeviceId = n),
            !0
          );
        },
      },
      audioSource: {
        validate: function (n, e) {
          return (
            n instanceof MediaStreamTrack &&
              (e._sharedTracks.audioDeviceId = n),
            (e._preloadCache.audioDeviceId = n),
            !0
          );
        },
      },
      ...
      theme: {
        validate: function (n) {
          ...
          return j(n) === "object" &&
            (("light" in n && "dark" in n) || "colors" in n)
            ? "light" in n && "dark" in n
              ? "colors" in n.light
                ? "colors" in n.dark
                  ? t(n.light.colors) && t(n.dark.colors)
                  : (console.error(
        ...
        validate: function (n) {
          if ("grid" in n) {
            ...
            if ("minTilesPerPage" in e) {
              ...
              if (
                "maxTilesPerPage" in e &&
                e.minTilesPerPage > e.maxTilesPerPage
              )
                return (
                  console.error(
      ...
      receiveSettings: {
        validate: function (n) {
          return ls(n, { allowAllParticipantsKey: !1 });
        },
        help: hs({ allowAllParticipantsKey: !1 }),
      },
      sendSettings: {
        validate: function (n, e) {
          return (
      ...
      inputSettings: {
        validate: function (n, e) {
          ...
          return (
            !!us(n) &&
            (e._preloadCache.inputSettings ||
              (e._preloadCache.inputSettings = {}),
            ds(
              n,
              (t = e.properties) === null || t === void 0
                ? void 0
                : t.dailyConfig
            ),
            n.audio && (e._preloadCache.inputSettings.audio = n.audio),
            n.video && (e._preloadCache.inputSettings.video = n.video),
            !0)
          );
        },
        help: sr(),
  ...
  var Qc = (function (n) {
    ...
    function re(o) {
      ...
      if (
        ...
        ke(_e(a), "handleDeviceChange", function (v) {
          (v = v.map(function (E) {
            ...
            a.emit(Gi, { action: Gi, availableDevices: v });
        }),
        ke(
          _e(a),
            ...
            var v = C(function* (E) {
              if (E === "destroyed")
                return (
                  ...
                  void (yield a.destroy())
                );
              var k = E === "active";
              a.disableReactNativeAutoDeviceManagement("video") ||
                (k
                  ? a.camUnmutedBeforeLosingNativeActiveState &&
                    a.setLocalVideo(!0)
                  : ((a.camUnmutedBeforeLosingNativeActiveState =
                      a.localVideo()),
                    a.camUnmutedBeforeLosingNativeActiveState &&
        ...
        ke(_e(a), "handleNativeAudioFocusChange", function (v) {
          a.disableReactNativeAutoDeviceManagement("audio") ||
            ((a._hasNativeAudioFocus = v),
            a.toggleParticipantAudioBasedOnNativeAudioFocus(),
            a._hasNativeAudioFocus
              ? a.micUnmutedBeforeLosingNativeAudioFocus && a.setLocalAudio(!0)
              : ((a.micUnmutedBeforeLosingNativeAudioFocus = a.localAudio()),
                a.setLocalAudio(!1)));
        }),
        ke(_e(a), "handleNativeSystemScreenCaptureStop", function () {
          a.stopScreenShare();
        }),
        (a.strictMode = f.strictMode === void 0 || f.strictMode),
        fe)
      ) {
      ...
      if (
        ...
        (a._callFrameId = At()),
        (window._daily.instances[a._callFrameId] = {}),
        (a._sharedTracks = {}),
        (window._daily.instances[a._callFrameId].tracks = a._sharedTracks),
        (f.dailyJsVersion = re.version()),
        (a._iframe = o),
        (a._callObjectMode = f.layout === "none" && !a._iframe),
        (a._preloadCache = {
        ...
        f.showLocalVideo !== void 0
          ? a._callObjectMode
            ? console.error(
                "showLocalVideo is not available in call object mode"
              )
            : (a._showLocalVideo = !!f.showLocalVideo)
          : (a._showLocalVideo = !0),
        f.showParticipantsBar !== void 0
          ? a._callObjectMode
            ? console.error(
                "showParticipantsBar is not available in call object mode"
              )
            : (a._showParticipantsBar = !!f.showParticipantsBar)
          : (a._showParticipantsBar = !0),
        f.customIntegrations !== void 0
          ? a._callObjectMode
            ? console.error(
                "customIntegrations is not available in call object mode"
              )
            : (a._customIntegrations = f.customIntegrations)
          : (a._customIntegrations = {}),
        f.customTrayButtons !== void 0
          ? a._callObjectMode
            ? console.error(
                "customTrayButtons is not available in call object mode"
              )
            : (a._customTrayButtons = f.customTrayButtons)
          : (a._customTrayButtons = {}),
        f.activeSpeakerMode !== void 0
          ? a._callObjectMode
            ? console.error(
                "activeSpeakerMode is not available in call object mode"
              )
            : (a._activeSpeakerMode = !!f.activeSpeakerMode)
          : (a._activeSpeakerMode = !1),
        f.receiveSettings
          ? a._callObjectMode
            ? (a._receiveSettings = f.receiveSettings)
            : console.error(
                "receiveSettings is only available in call object mode"
              )
          : (a._receiveSettings = {}),
        a.validateProperties(f),
        (a.properties = A({}, f)),
        a._preloadCache.inputSettings || (a._preloadCache.inputSettings = {}),
        f.inputSettings &&
          f.inputSettings.audio &&
          (a._preloadCache.inputSettings.audio = f.inputSettings.audio),
        f.inputSettings &&
          f.inputSettings.video &&
          (a._preloadCache.inputSettings.video = f.inputSettings.video),
        (a._callObjectLoader = a._callObjectMode
          ? new Lc(a._callFrameId)
          : null),
        (a._callState = xn),
        (a._isPreparingToJoin = !1),
        (a._accessState = { access: Jt }),
        (a._meetingSessionSummary = {}),
        (a._finalSummaryOfPrevSession = {}),
        (a._meetingSessionState = ar(ns, a._callObjectMode)),
        (a._nativeInCallAudioMode = ts),
        (a._participants = {}),
        (a._isScreenSharing = !1),
        (a._participantCounts = rs),
        (a._rmpPlayerState = {}),
        (a._waitingParticipants = {}),
        (a._network = { threshold: "good", quality: 100 }),
        (a._activeSpeaker = {}),
        (a._localAudioLevel = 0),
        (a._remoteParticipantsAudioLevel = {}),
        (a._messageChannel = N() ? new Mc() : new Tc()),
        a._iframe &&
          (a._iframe.requestFullscreen
            ? a._iframe.addEventListener("fullscreenchange", function () {
                document.fullscreenElement === a._iframe
                  ? (a.emit(Ye, { action: Ye }),
                    a.sendMessageToCallMachine({ action: Ye }))
                  : (a.emit($e, { action: $e }),
                    a.sendMessageToCallMachine({ action: $e }));
              })
            : a._iframe.webkitRequestFullscreen &&
              a._iframe.addEventListener("webkitfullscreenchange", function () {
                document.webkitFullscreenElement === a._iframe
                  ? (a.emit(Ye, { action: Ye }),
                    a.sendMessageToCallMachine({ action: Ye }))
                  : (a.emit($e, { action: $e }),
                    a.sendMessageToCallMachine({ action: $e }));
        ...
        var g = a.nativeUtils();
        (g.addAudioFocusChangeListener &&
          g.removeAudioFocusChangeListener &&
          g.addAppStateChangeListener &&
          g.removeAppStateChangeListener &&
          g.addSystemScreenCaptureStopListener &&
          g.removeSystemScreenCaptureStopListener) ||
          console.warn(
          ...
          (a._hasNativeAudioFocus = !0),
          g.addAudioFocusChangeListener(a.handleNativeAudioFocusChange),
          g.addAppStateChangeListener(a.handleNativeAppStateChange),
          g.addSystemScreenCaptureStopListener(
            a.handleNativeSystemScreenCaptureStop
          );
      }
      return (
        a._callObjectMode && a.startListeningForDeviceChanges(),
        a._messageChannel.addListenerForMessagesFromCallMachine(
          a.handleMessageFromCallMachine,
          a._callFrameId,
          _e(a)
        ),
        a
      ...
      ae(
        ...
        [
          ...
          },
          {
            ...
            value: function () {
              return (
                me(this._callObjectMode, "accessState()"), this._accessState
              );
            },
          },
          {
          ...
          },
          {
            ...
            value: function () {
              return (
                me(this._callObjectMode, "waitingParticipants()"),
          ...
          },
          {
            ...
            value: function (o, a) {
              for (var d in a) {
                if (!nn[d])
                  throw new Error(
                    "unrecognized updateParticipant property ".concat(d)
                  );
                if (
                  nn[d].validate &&
                  !nn[d].validate(a[d], this, this._participants[o])
                )
                  throw new Error(nn[d].help);
              }
            },
          },
          {
            ...
            value: function (o, a) {
              return (
                this._participants.local &&
                  this._participants.local.session_id === o &&
                  (o = "local"),
                o &&
                  a &&
                  (this.validateParticipantProperties(o, a),
                  this.sendMessageToCallMachine({
          ...
          },
          {
            ...
            value: function (o) {
              ...
              for (var d in o)
                d === a && (d = "local"),
                  d && o[d] && this.validateParticipantProperties(d, o[d]);
              return (
                this.sendMessageToCallMachine({
                ...
                var o = this,
                  ...
                  d =
                    arguments.length > 1 && arguments[1] !== void 0
                      ...
                      : {};
                if (
                  (me(this._callObjectMode, "updateWaitingParticipant()"),
                  Y(this._callState, "updateWaitingParticipant()"),
                  typeof a != "string" || j(d) !== "object")
                )
                  throw new Error(
                ...
                var o = this,
                  a =
                    arguments.length > 0 && arguments[0] !== void 0
                      ...
                      : {};
                if (
                  (me(this._callObjectMode, "updateWaitingParticipants()"),
                ...
                var o = this,
                  a =
                    arguments.length > 0 && arguments[0] !== void 0
                      ...
                      : {},
                  d = a.access,
                  f = d === void 0 ? { level: Ri } : d,
                  g = a.name,
                  v = g === void 0 ? "" : g;
                return (
                  me(this._callObjectMode, "requestAccess()"),
                  Y(this._callState, "requestAccess()"),
                  new Promise(function (E, k) {
                    o.sendMessageToCallMachine(
                      ...
                      function (P) {
                        P.error && k(P.error),
                          P.access ||
                            k(new Error("unknown error in requestAccess()")),
                          E({ access: P.access, granted: P.granted });
                      }
                    );
                  })
                );
            ...
            value:
              ((Ys = C(function* (o) {
                var a = this,
                  ...
                  f = d !== void 0 && d;
                if (
                  (me(this._callObjectMode, "getReceiveSettings()"),
          ...
          },
          {
            ...
            value:
              ((Vs = C(function* (o) {
                var a = this;
                if (
                  (me(this._callObjectMode, "updateReceiveSettings()"),
                  !ls(o, { allowAllParticipantsKey: !0 }))
                )
                  throw new Error(hs({ allowAllParticipantsKey: !0 }));
                return (
                  Y(
                    this._callState,
                  ...
                  new Promise(function (d) {
                    a.sendMessageToCallMachine(
                      { action: "update-receive-settings", receiveSettings: o },
                      function (f) {
              ...
              if (o) {
                var J = {},
                  H =
                    ...
                    g === void 0
                      ? void 0
                      : g._isDefaultWhenNone);
                if (o.audio && !H) {
                  var K = A({}, o.audio.processor);
                  delete K._isDefaultWhenNone,
                    (J.audio = A(A({}, o.audio), {}, { processor: K }));
                }
                var ie =
                  ((v = o.video) === null ||
                  v === void 0 ||
                  ...
                  P === void 0
                    ? void 0
                    : P._isDefaultWhenNone);
                if (o.video && !ie) {
                  var q = A({}, o.video.processor);
                  delete q._isDefaultWhenNone,
                    (J.video = A(A({}, o.video), {}, { processor: q }));
                }
                return J;
              }
            },
          ...
          },
          {
            ...
            value: function () {
              var o,
                ...
                E,
                k,
                P = { processor: { type: "none", _isDefaultWhenNone: !0 } };
              this._inputSettings
                ? ((o =
                    ((d = this._inputSettings) === null || d === void 0
                      ? void 0
                      : d.video) || P),
                  (a =
                    ((f = this._inputSettings) === null || f === void 0
                      ? void 0
                      : f.audio) || P))
                : ((o =
                    ((g = this._preloadCache) === null ||
                    g === void 0 ||
                    (v = g.inputSettings) === null ||
                    v === void 0
                      ? void 0
                      : v.video) || P),
                  (a =
                    ((E = this._preloadCache) === null ||
                    E === void 0 ||
                    (k = E.inputSettings) === null ||
                    k === void 0
                      ? void 0
                      : k.audio) || P));
                  ...
                  us(o)
                    ? (o &&
                        (this._preloadCache.inputSettings ||
                          (this._preloadCache.inputSettings = {}),
                        ds(o, this.properties.dailyConfig),
                        o.audio &&
                          (this._preloadCache.inputSettings.audio = o.audio),
                        o.video &&
                          (this._preloadCache.inputSettings.video = o.video)),
                      o.video || o.audio
                              ...
                              a.sendMessageToCallMachine(
                                ...
                                function (g) {
                                  g.error
                                    ...
                                    : d({
                                        inputSettings:
                                          a._prepInputSettingsToPresentToUser(
                                            g.inputSettings
                                          ),
                                      });
                                }
                        ...
                        : this._getInputSettings())
                    : (console.error(sr()), Promise.reject(sr()))
                );
              })),
              function (o) {
          ...
          },
          {
            ...
            value: function () {
              return [Se, we].includes(this._callState)
            ...
            value:
              ((Bs = C(function* () {
                ...
                return (
                  ...
                  Y(this._callState, "getMeetingSession()"),
                  new Promise(function (a) {
                    o.sendMessageToCallMachine(
                      { action: "get-meeting-session" },
                      function (d) {
                        delete d.action,
                          delete d.callbackStamp,
                          delete d.callFrameId,
                          a(d);
                      }
                    );
                  })
          ...
          },
          {
            ...
            value: function () {
              return (
                Y(this._callState, "meetingSessionState"),
                this._meetingSessionState
              );
            },
          },
          {
            ...
            value: function (o) {
              var a =
                arguments.length > 1 && arguments[1] !== void 0
                  ? arguments[1]
                  : "replace";
              me(this._callObjectMode, "setMeetingSessionData()"),
                Y(this._callState, "setMeetingSessionData");
              try {
                (function (d, f) {
              ...
              try {
                ...
                throw new Error(
                  "Error setting meeting session data: ".concat(d)
                );
              }
            },
          },
          ...
          },
          {
            ...
            value:
              ((Fs = C(function* (o) {
                ...
                if (
                  ((this.properties.userData = o), this._callMachineInitialized)
                )
                  return new Promise(function (d) {
                    try {
                      a.sendMessageToCallMachine(
                        { action: "set-user-data", userData: o },
                        function (f) {
                          delete f.action,
                            delete f.callbackStamp,
                            delete f.callFrameId,
                            d(f);
                        }
                      );
                    } catch (f) {
          ...
          },
          {
            ...
            value: function (o) {
              ...
              if (
                (this.validateAudioLevelInterval(o),
                this._callMachineInitialized)
              )
                return new Promise(function (d, f) {
                  a.sendMessageToCallMachine(
                    { action: "start-local-audio-level-observer", interval: o },
                    function (g) {
                ...
                var o = this,
                  a =
                    arguments.length > 0 && arguments[0] !== void 0
                      ...
                      : {};
                if (
                  (me(this._callObjectMode, "startCamera()"),
                  as(
                    this._callState,
                  ...
                  qe(this._testCallInProgress, "startCamera()"),
                  this.needsLoad())
                )
                  try {
                    yield this.load(a);
                  ...
                  this.validateProperties(a),
                    (this.properties = A(A({}, this.properties), a));
                }
                return new Promise(function (d) {
                  o.sendMessageToCallMachine(
                    {
            ...
            value: function () {
              var o = this,
                a =
                  arguments.length > 0 && arguments[0] !== void 0
                    ? arguments[0]
                    : { track, mode, trackName };
              return (
                I(),
                Y(this._callState, "startCustomTrack()"),
                this.validateCustomTrack(a.track, a.mode, a.trackName),
                new Promise(function (d, f) {
                  (o._sharedTracks.customTrack = a.track),
                    (a.track = St),
                    o.sendMessageToCallMachine(
                      { action: "start-custom-track", properties: a },
                      function (g) {
          ...
          },
          {
            ...
            value: function (o) {
              ...
              return (
                I(),
                Y(this._callState, "stopCustomTrack()"),
                new Promise(function (d) {
                  a.sendMessageToCallMachine(
                    { action: "stop-custom-track", mediaTag: o },
                    function (f) {
                      d(f.mediaTag);
                    }
                  );
          ...
          },
          {
            ...
            value: function (o) {
              ...
              return (
                Et(),
                or(this._callMachineInitialized, "setCamera()"),
                new Promise(function (d) {
                  a.sendMessageToCallMachine(
                    { action: "set-camera", cameraDeviceId: o },
                    function (f) {
                      d({ device: f.device });
                    }
                  );
          ...
          },
          {
            ...
            value:
              ((xs = C(function* (o) {
                return (
                  Et(),
                  this.nativeUtils().setAudioDevice(o),
          ...
          },
          {
            ...
            value: function () {
              ...
              return new Promise(function (d) {
                o.sendMessageToCallMachine(
                  { action: "cycle-camera", properties: a },
                  function (f) {
                    d({ device: f.device });
                  }
                );
            ...
            value:
              ((Rs = C(function* (o) {
                ...
                return (
                  ...
                  v !== void 0 && (f = v),
                  d &&
                    ((this._preloadCache.audioDeviceId = d),
                    (this._sharedTracks.audioDeviceId = d)),
                  f &&
                    ((this._preloadCache.videoDeviceId = f),
                    (this._sharedTracks.videoDeviceId = f)),
                  this._callObjectMode && this.needsLoad()
                    ...
                    : (d instanceof MediaStreamTrack && (d = St),
                      f instanceof MediaStreamTrack && (f = St),
                      new Promise(function (E) {
                        a.sendMessageToCallMachine(
                          ...
                          function (k) {
                            delete k.action,
                              delete k.callbackStamp,
                              k.returnPreloadCache
                                ? E({
                                    camera: {
              ...
              ((Ns = C(function* (o) {
                ...
                return (
                  ...
                  this._callObjectMode && this.needsLoad()
                    ...
                    : new Promise(function (f) {
                        a.sendMessageToCallMachine(
                          { action: "set-output-device", outputDeviceId: d },
                          function (g) {
                            delete g.action,
                              delete g.callbackStamp,
                              g.returnPreloadCache
                                ? f({
                                    camera: {
                                      deviceId: a._preloadCache.videoDeviceId,
                                    },
            ...
            value: function (o) {
              if ((Et(), [ts, Kc].includes(o))) {
                if (o !== this._nativeInCallAudioMode)
                  return (
                    (this._nativeInCallAudioMode = o),
                    !this.disableReactNativeAutoDeviceManagement("audio") &&
                      rn(this._callState, this._isPreparingToJoin) &&
                ...
                var o = this,
                  a =
                    arguments.length > 0 && arguments[0] !== void 0
                      ...
                      : {};
                if (
                  (me(this._callObjectMode, "preAuth()"),
                  as(this._callState, this._isPreparingToJoin, "preAuth()"),
                  qe(this._testCallInProgress, "preAuth()"),
                  this.needsLoad() && (yield this.load(a)),
                  !a.url)
                )
                  throw new Error(
                    ...
                    o.sendMessageToCallMachine(
                      ...
                      function (g) {
                        return g.error
                          ? f(g.error)
                          : g.access
                          ? ((o._didPreAuth = !0), void d({ access: g.access }))
            ...
            value:
              ((kt = C(function* (o) {
                ...
                if (this.needsLoad()) {
                  if (
                    this._destroyed &&
                    (this._logUseAfterDestroy(), this.strictMode)
                  )
                    throw new Error("Use after destroy");
                  if (
                    (o &&
                      (this.validateProperties(o),
                      (this.properties = A(A({}, this.properties), o))),
                  ...
                  return this._callObjectMode
                    ? new Promise(function (d, f) {
                        ...
                        a._callObjectLoader.load(
                          ...
                          function (v) {
                            (a._bundleLoadTime = v ? "no-op" : Date.now() - g),
                              a._updateCallState(Ni),
                              v && a.emit(Wt, { action: Wt }),
                              d();
                          },
                          function (v, E) {
                            if ((a.emit(Bn, { action: Bn, error: v }), !E)) {
                              a._updateCallState(we),
            ...
            value:
              ((at = C(function* () {
                ...
                if (
                  ...
                  this._callState === Ve || this._callState === qt)
                )
                  return (
                    console.warn(
                ...
                return (
                  this._preloadCache.inputSettings ||
                    (this._preloadCache.inputSettings = {}),
                  a.inputSettings &&
                    a.inputSettings.audio &&
                    (this._preloadCache.inputSettings.audio =
                      a.inputSettings.audio),
                  a.inputSettings &&
                    a.inputSettings.video &&
                        ...
                        if ((o._updateCallState(Ve), v))
                          for (var k in v) {
                            if (o._callObjectMode) {
                              ...
                              Jo(v[k], P),
                                Wo(v[k], P),
                                zo(v[k], o._participants[k], P);
                            }
                            (o._participants[k] = A({}, v[k])),
                              o.toggleParticipantAudioBasedOnNativeAudioFocus();
                          }
                ...
                return (
                  ...
                  new Promise(function (a) {
                    if (o._callState === Se || o._callState === we) a();
                      ...
                      o._callObjectLoader &&
                      !o._callObjectLoader.loaded
                    ) {
                      o._callObjectLoader.cancel(),
                        o._updateCallState(Se),
                      ...
                      (o._resolveLeave = a),
                        o.sendMessageToCallMachine({ action: "leave-meeting" });
                  })
                );
              })),
              function () {
          ...
          },
          {
            ...
            value:
              ((G = C(function* () {
                var o = this,
                  a =
                    arguments.length > 0 && arguments[0] !== void 0
                      ...
                      : {};
                if (
                  (or(this._callMachineInitialized, "startScreenShare()"),
                  a.screenVideoSendSettings &&
                    this._validateVideoSendSettings(
                      "screenVideo",
                      a.screenVideoSendSettings
                    ),
                  a.mediaStream &&
                    ((this._sharedTracks.screenMediaStream = a.mediaStream),
                    (a.mediaStream = St)),
                  typeof DailyNativeUtils < "u" &&
                    DailyNativeUtils.isIOS !== void 0 &&
                    DailyNativeUtils.isIOS)
                ) {
                  var d = this.nativeUtils();
                  if (yield d.isScreenBeingCaptured())
                    return void this.emit(Kt, {
                      action: Kt,
                  ...
                  d.setSystemScreenCaptureStartCallback(function () {
                    d.setSystemScreenCaptureStartCallback(null),
                      o.sendMessageToCallMachine({
                        action: Po,
                        captureOptions: a,
                      });
                ...
                } else this.sendMessageToCallMachine({ action: Po, captureOptions: a });
              })),
              function () {
          ...
          },
          {
            key: "stopScreenShare",
            value: function () {
              or(this._callMachineInitialized, "stopScreenShare()"),
            ...
            value: function () {
              var o =
                arguments.length > 0 && arguments[0] !== void 0
                  ...
                  : {};
              this.sendMessageToCallMachine(
                A({ action: "local-recording-start" }, o)
              );
            },
          },
          {
            ...
            value: function () {
              var o =
                arguments.length > 0 && arguments[0] !== void 0
                  ...
                  : {};
              this.sendMessageToCallMachine(
                A({ action: "local-recording-stop" }, o)
              );
            },
          },
          {
            ...
            value: function () {
              var o =
                arguments.length > 0 && arguments[0] !== void 0
                  ...
                  : {};
              this.sendMessageToCallMachine(
                A({ action: "daily-method-start-live-streaming" }, o)
              );
            },
          },
          {
            ...
            value: function () {
              var o =
                arguments.length > 0 && arguments[0] !== void 0
                  ...
                  : {};
              this.sendMessageToCallMachine(
                A({ action: "daily-method-stop-live-streaming" }, o)
              );
            },
          },
          {
            ...
            value: function (o) {
              o.camSimulcastEncodings &&
                (console.warn(
                  "camSimulcastEncodings is deprecated. Use sendSettings, found in DailyCallOptions, to provide camera simulcast settings."
                ),
                this.validateSimulcastEncodings(o.camSimulcastEncodings)),
                o.screenSimulcastEncodings &&
                  console.warn(
                    "screenSimulcastEncodings is deprecated. Use sendSettings, found in DailyCallOptions, to provide screen simulcast settings."
                  ),
                de().match(/Linux; Android/) &&
          ...
          },
          {
            ...
            value: function (o) {
              ...
              if (o) {
                ...
                if (!_s(o.length, 1, 3))
                  throw new Error(
                    "encodings must be an Array with between 1 to ".concat(
                      3,
                      " layers"
                    )
                  );
                for (var f = 0; f < o.length; f++) {
                  var g = o[f];
                  for (var v in (this._validateEncodingLayerHasValidProperties(
                    g
                  ),
                  g))
                    if (rr.includes(v)) {
                      ...
                      if (a) {
                        ...
                        if (!_s(g[v], k, P))
                          throw new Error(
                            ""
                              .concat(v, " value not in range. valid range: ")
                              .concat(k, " to ")
                              .concat(P)
                          );
                      }
                      ...
                      throw new Error(
                        "Invalid key ".concat(v, ", valid keys are:") +
                          Object.values(rr)
                      );
            ...
            value:
              ((L = C(function* (o) {
                ...
                try {
                    ...
                    (function (v) {
                      for (var E in v)
                        if (!os.includes(E))
                          throw new Error(
                            "Invalid key "
                              .concat(E, ", valid keys are: ")
                              .concat(os)
                          );
                      v.simulcastEncodings &&
                  ...
                  throw (
                    (console.error("invalid argument Error: ".concat(v)),
  ...
  {state: "play"|"pause", simulcastEncodings?: [{}] } }`),
                ...
                return new Promise(function (v, E) {
                  a.sendMessageToCallMachine(
                    ...
                    function (k) {
                      k.error
                        ? E({ error: k.error, errorMsg: k.errorMsg })
                        : v({
              ...
              ((T = C(function* (o) {
                ...
                return new Promise(function (d, f) {
                  a.sendMessageToCallMachine(
                    ...
                    function (g) {
                      g.error
                        ? f({ error: g.error, errorMsg: g.errorMsg })
                        : d();
                    }
                  );
                });
  ...
  { settings?: {state: "play"|"pause"} }`),
                ...
                return new Promise(function (g, v) {
                  a.sendMessageToCallMachine(
                    ...
                    function (E) {
                      E.error
                        ? v({ error: E.error, errorMsg: E.errorMsg })
                        : g({
          ...
          },
          {
            ...
            value: function (o) {
              this.sendMessageToCallMachine(
                A({ action: "daily-method-start-transcription" }, o)
              );
            },
          },
          {
              ...
              ((b = C(function* (o) {
                ...
                if (o.sipUri) {
                  if (typeof o.sipUri != "string")
                    throw new Error(
                      "Error starting dial out: sipUri must be a string"
                    );
                ...
                if (o.callerId) {
                  if (typeof o.callerId != "string")
                    throw new Error(
                      "Error starting dial out: callerId must be a string"
                    );
                  if (o.sipUri)
                    throw new Error(
          ...
          },
          {
            ...
            value: function (o) {
              var a = this;
              return (
                Y(this._callState, "stopDialOut()"),
                new Promise(function (d, f) {
                  a.sendMessageToCallMachine(
                    A({ action: "dialout-stop" }, o),
                    function (g) {
          ...
          },
          {
            ...
            value:
              ((w = C(function* (o) {
                var a = this;
                return (
                  Y(this._callState, "sendDTMF()"),
                  (function (d) {
                    var f = d.sessionId,
                      g = d.tones;
                    if (!f || !g)
                      throw new Error(
                        "sessionId and tones are mandatory parameter"
                      );
                    if (typeof f != "string" || typeof g != "string")
                      throw new Error(
                        "sessionId and tones should be of string type"
                      );
                    if (g.length > 20)
                      throw new Error(
                    ...
                    if (E && E[0])
                      throw new Error(
                        "".concat(E[0], " is not valid DTMF tone")
                      );
                  })(o),
                  new Promise(function (d, f) {
                    a.sendMessageToCallMachine(
                      A({ action: "send-dtmf" }, o),
                      function (g) {
                        g.error ? f(g.error) : d(g);
                      }
                    );
          ...
          },
          {
            ...
            value:
              ((y = C(function* () {
                var o = this;
                if (
                  (qe(this._testCallInProgress, "testWebsocketConnectivity()"),
                  this.needsLoad())
                )
                  try {
                    yield this.load();
          ...
          },
          {
            ...
            value: function (o) {
              return o
                ? o instanceof MediaStreamTrack
                  ? !!qc(o, { isLocalScreenVideo: !1 }) ||
                    (console.error(
                      "Video track is not playable. This test needs a live video track."
                    ),
                    !1)
                  : (console.error(
                      "Video track needs to be of type `MediaStreamTrack`."
                    ),
                    !1)
                : (console.error(
            ...
            value:
              ((m = C(function* (o) {
                ...
                if (
                  ...
                  o.videoTrack &&
                    !this._validateVideoTrackForNetworkTests(o.videoTrack))
                )
                ...
                var g = o.videoTrack,
                  v = ln(o, Jc);
                if (
                  ((this._sharedTracks.videoTrackForConnectionQualityTest = g),
                  this.needsLoad())
                )
                  try {
                  ...
                  a.sendMessageToCallMachine(
                    ...
                    function (P) {
                      ...
                      if (H === "failed") {
                        var ie,
                          q = A({}, K);
                        (ie = K.error) !== null && ie !== void 0 && ie.details
                          ? ((K.error.details = JSON.parse(K.error.details)),
                            (q.error = A(
                              A({}, q.error),
                              {},
                              { details: A({}, q.error.details) }
                            )),
                            (q.error.details.duringTest = "testCallQuality"))
                          : ((q.error = q.error ? A({}, q.error) : {}),
                            (q.error.details = {
          ...
          },
          {
            ...
            value:
              ((p = C(function* (o) {
                console.warn(
                  "testConnectionQuality() is deprecated: use testPeerToPeerCallQuality() instead"
                );
                var a = yield this.testPeerToPeerCallQuality(o),
                  d = { result: a.result, secondsElapsed: a.secondsElapsed };
                return (
                  a.data &&
                    (d.data = {
          ...
          },
          {
            ...
            value:
              ((h = C(function* (o) {
                var a = this;
                if (
                  (qe(this._testCallInProgress, "testConnectionQuality()"),
                  this.needsLoad())
                )
                  try {
                    yield this.load();
                ...
                if (!this._validateVideoTrackForNetworkTests(d))
                  throw new Error("Video track error");
                return (
                  (this._sharedTracks.videoTrackForConnectionQualityTest = d),
                  new Promise(function (g, v) {
                    a.sendMessageToCallMachine(
                      { action: "test-p2p-call-quality", duration: f },
                      function (E) {
          ...
          },
          {
            ...
            value: function () {
              console.warn(
                "stopTestConnectionQuality() is deprecated: use stopTestPeerToPeerCallQuality() instead"
              ),
          ...
          },
          {
            ...
            value:
              ((u = C(function* (o) {
                var a = this;
                if (
                  (qe(this._testCallInProgress, "testNetworkConnectivity()"),
                  this.needsLoad())
                )
                  try {
                    yield this.load();
                ...
                if (!this._validateVideoTrackForNetworkTests(o))
                  throw new Error("Video track error");
                return (
                  (this._sharedTracks.videoTrackForNetworkConnectivityTest = o),
                  new Promise(function (d, f) {
                    a.sendMessageToCallMachine(
          ...
          },
          {
            ...
            value: function (o, a) {
              var d =
                ...
                f =
                  "Video send settings should be either an object or one of the supported presets: ".concat(
                    d.join()
                  );
              if (typeof a == "string") {
                ...
                if (
                  a.maxQuality &&
                  ["low", "medium", "high"].indexOf(a.maxQuality) === -1
                )
                  throw new Error(
                    "maxQuality must be either low, medium or high"
                  );
                if (a.encodings) {
                  var g = !1;
          ...
          },
          {
            ...
            value: function (o) {
              ...
              return (
                ...
                this.needsLoad()
                  ? ((this._preloadCache.sendSettings = o),
                    { sendSettings: this._preloadCache.sendSettings })
                  : new Promise(function (d, f) {
                      a.sendMessageToCallMachine(
                        { action: "update-send-settings", sendSettings: o },
                        function (g) {
          ...
          },
          {
            ...
            value: function (o) {
              return (
                ...
                (this._preloadCache.subscribeToTracksAutomatically = o),
                this.sendMessageToCallMachine({
            ...
            value: function (o) {
              var a =
                arguments.length > 1 && arguments[1] !== void 0
                  ...
                  : "*";
              if (
                (Y(this._callState, "sendAppMessage()"),
                JSON.stringify(o).length > 4096)
              )
          ...
          },
          {
            ...
            value: function (o) {
              return (
                I(),
                Y(this._callState, "addFakeParticipant()"),
                this.sendMessageToCallMachine(
                  A({ action: "add-fake-participant" }, o)
                ),
                this
              );
            },
          },
          {
            ...
            value: function (o) {
              return (
                te(this._callObjectMode, "setShowNamesMode()"),
                I(),
                o && o !== "always" && o !== "never"
                  ? (console.error(
          ...
          },
          {
            ...
            value: function () {
              var o =
                ...
                arguments[0];
              return (
                te(this._callObjectMode, "setShowLocalVideo()"),
                I(),
                Y(this._callState, "setShowLocalVideo()"),
                typeof o != "boolean"
                  ? (console.error(
          ...
          },
          {
            ...
            value: function () {
              return (
                te(this._callObjectMode, "showLocalVideo()"),
                I(),
          ...
          },
          {
            ...
            value: function () {
              var o =
                ...
                arguments[0];
              return (
                te(this._callObjectMode, "setShowParticipantsBar()"),
                I(),
                Y(this._callState, "setShowParticipantsBar()"),
                typeof o != "boolean"
                  ? (console.error(
          ...
          },
          {
            ...
            value: function () {
              return (
                te(this._callObjectMode, "showParticipantsBar()"),
                I(),
          ...
          },
          {
            ...
            value: function () {
              return (
                I(),
                te(this._callObjectMode, "customIntegrations()"),
          ...
          },
          {
            ...
            value: function (o) {
              return (
                I(),
                te(this._callObjectMode, "setCustomIntegrations()"),
                Y(this._callState, "setCustomIntegrations()"),
                ms(o)
                  ? (this.sendMessageToCallMachine({
                      action: "set-custom-integrations",
                      integrations: o,
                    }),
                    (this._customIntegrations = o),
                    this)
                  : this
              );
            },
          },
          {
            ...
            value: function (o) {
              ...
              if (
                ...
                Y(this._callState, "startCustomIntegrations()"),
                (Array.isArray(o) &&
                  o.some(function (g) {
                ...
                return (
                  console.error(
                    "startCustomIntegrations() only accepts string | string[]"
                  ),
                  this
                );
              ...
              return f.length
                ? (console.error(
                    `Can't find custom integration(s): "`.concat(
                      f.join(", "),
                      '"'
                    )
                  ),
          ...
          },
          {
            ...
            value: function (o) {
              ...
              if (
                ...
                Y(this._callState, "stopCustomIntegrations()"),
                (Array.isArray(o) &&
                  o.some(function (g) {
                    return typeof g != "string";
                  })) ||
                ...
                return (
                  console.error(
                    "stopCustomIntegrations() only accepts string | string[]"
                  ),
                  this
                );
              var d = typeof o == "string" ? [o] : o,
          ...
          },
          {
            ...
            value: function () {
              return (
                te(this._callObjectMode, "customTrayButtons()"),
                I(),
          ...
          },
          {
            ...
            value: function (o) {
              return (
                te(this._callObjectMode, "updateCustomTrayButtons()"),
                I(),
                Y(this._callState, "updateCustomTrayButtons()"),
                fs(o)
                  ? (this.sendMessageToCallMachine({
                      action: "update-custom-tray-buttons",
                      btns: o,
                    }),
                    (this._customTrayButtons = o),
                    this)
                  : (console.error(
          ...
          },
          {
            ...
            value: function (o) {
              ...
              return (
                ...
                new Promise(function (d, f) {
                  try {
                    a.validateProperties({ theme: o }),
                      (a.properties.theme = A({}, o)),
                      a.sendMessageToCallMachine({
                        action: "set-theme",
                        theme: a.properties.theme,
                      });
                    try {
                      a.emit(jn, { action: jn, theme: a.properties.theme });
                    } catch (g) {
          ...
          },
          {
            ...
            value:
              ((c = C(function* () {
                if ((I(), this._iframe && !document.fullscreenElement && xo()))
                  try {
          ...
          },
          {
            ...
            value:
              ((s = C(function* () {
                ...
                return this._callObjectMode
                  ? (console.error(
                      "getSidebarView is not available in callObject mode"
                    ),
          ...
          },
          {
            ...
            value: function (o) {
              return this._callObjectMode
                ? (console.error(
                    "setSidebarView is not available in callObject mode"
                  ),
                  this)
                : (this.sendMessageToCallMachine({
          ...
          },
          {
            ...
            value:
              ((t = C(function* (o) {
                ...
                return (
                  I(),
                  Y(this._callState, "setNetworkTopology()"),
                  new Promise(function (d, f) {
                    a.sendMessageToCallMachine(
                      { action: "set-network-topology", opts: o },
                      function (g) {
                        g.error
                          ? f({ error: g.error })
                          : d({ workerId: g.workerId });
                      }
                    );
                  })
                );
          ...
          },
          {
            ...
            value:
              ((e = C(function* () {
                var o = this;
                return new Promise(function (a, d) {
                  o.needsLoad() && a({ topology: "none" }),
                    o.sendMessageToCallMachine(
                      { action: "get-network-topology" },
                      function (f) {
                        f.error
                          ? d({ error: f.error })
                          : a({ topology: f.topology });
                      }
                    );
                });
              })),
          ...
          },
          {
            ...
            value: function (o) {
              for (var a in o) {
                ...
                if (Ge[a].validate && !Ge[a].validate(o[a], this))
                  throw new Error(
                    "property '".concat(a, "': ").concat(Ge[a].help)
                  );
              }
            },
          },
              ...
              var o,
                ...
                d = A(
                  ...
                  {},
                  {
                    ...
                    proxy:
                      (o = this.properties.dailyConfig) !== null &&
                      o !== void 0 &&
                      o.proxyUrl
                        ? encodeURIComponent(
                            (a = this.properties.dailyConfig) === null ||
                              a === void 0
                              ? void 0
                              : a.proxyUrl
                          )
              ...
              switch (o.action) {
                ...
                case Yi:
                  this._joinedCallback &&
                    (this._joinedCallback(o.participants),
                ...
                case Ji:
                  ...
                  if (o.participant && o.participant.session_id) {
                    var d = o.participant.local
                      ? "local"
                      : o.participant.session_id;
                    if (this._callObjectMode) {
                      var f = this._callMachine().store;
                      Jo(o.participant, f),
                        Wo(o.participant, f),
                        zo(o.participant, this._participants[d], f);
                    }
                    try {
                      this.maybeParticipantTracksStopped(
                        this._participants[d],
                        o.participant
                      ),
                    ...
                    if (
                      ...
                      (this._participants[d] = A({}, o.participant)),
                ...
                case Wi:
                  if (o.participant && o.participant.session_id) {
                    ...
                    g && this.maybeParticipantTracksStopped(g, null),
                      delete this._participants[o.participant.session_id];
                    try {
                      this.emit(o.action, o);
                    } catch (M) {
                      console.log("could not emit", o, M);
                ...
                case Hi:
                  ...
                  if (
                    (o.awaitingAccess && (v.awaitingAccess = o.awaitingAccess),
                    !X(this._accessState, v))
                  ) {
                    this._accessState = v;
                    try {
                      this.emit(o.action, o);
                ...
                case Qt:
                  var k;
                  this._iframe && !o.preserveIframe && (this._iframe.src = ""),
                    this._updateCallState(we),
                    this.resetMeetingDependentVars(),
                    this._loadedCallback &&
                      (this._loadedCallback(o.errorMsg),
                  ...
                  P != null &&
                    ...
                    k !== void 0 &&
                    k.details &&
                    (P.error.details = JSON.parse(P.error.details)),
                    this._maybeSendToSentry(o),
                    this._joinedCallback &&
                      (this._joinedCallback(null, P),
                      (this._joinedCallback = null));
                  try {
                  ...
                  break;
                case $i:
                  this._callState !== we && this._updateCallState(Se),
                    this.resetMeetingDependentVars(),
                    this._resolveLeave &&
                      (this._resolveLeave(), (this._resolveLeave = null));
                  try {
                    this.emit(o.action, o);
                  } catch (M) {
                    console.log("could not emit", o, M);
                ...
                case yo:
                  var J = o.threshold,
                    H = o.quality;
                  if (
                    J !== this._network.threshold ||
                    H !== this._network.quality
                  ) {
                ...
                case "show-local-video-changed":
                  ...
                  try {
                    this.emit(o.action, { action: o.action, show: ie });
                  } catch (M) {
                    console.log("could not emit", o, M);
                  }
                  break;
                ...
                case Oo:
                  if (!X(this._inputSettings, o.inputSettings)) {
                    ...
                    if (
                      ((this._inputSettings = o.inputSettings),
                      (this._preloadCache.inputSettings = {}),
                      !X(ur, this._getInputSettings()))
                    )
                      try {
                        this.emit(o.action, {
                          action: o.action,
                ...
                case "send-settings-updated":
                  if (!X(this._sendSettings, o.sendSettings)) {
                    (this._sendSettings = o.sendSettings),
                      (this._preloadCache.sendSettings = null);
                    try {
                      this.emit(o.action, {
                        action: o.action,
                ...
                case uo:
                  var Q = o.session_id;
                  (this._rmpPlayerState[Q] = o.playerState),
                    this.emitDailyJSEvent(o);
                  break;
                case po:
                  delete this._rmpPlayerState[o.session_id],
                    this.emitDailyJSEvent(o);
                  break;
                case ho:
                  var ge = o.session_id,
                ...
                case Qi:
                  var cn =
                    ...
                    (o.meetingSessionState && o.meetingSessionState.topology);
                  (this._meetingSessionState = ar(
                    o.meetingSessionState,
                    this._callObjectMode
                  )),
                    (this._callObjectMode || cn) && this.emitDailyJSEvent(o);
                  break;
                case fo:
              ...
              if (o)
                for (var d in o.tracks)
                  this.maybeEventTrackStopped(
                    o.tracks[d].track,
                    a && a.tracks[d] ? a.tracks[d].track : null,
                    a,
                    d
                  );
            },
              ...
              if (a)
                for (var d in a.tracks)
                  this.maybeEventTrackStarted(
                    o && o.tracks[d] ? o.tracks[d].track : null,
                    a.tracks[d].track,
                    a,
                    d
                  );
          ...
          },
          {
            ...
            value: function (o, a) {
              ...
              return (
                o.state === a.state &&
                ((d = o.settings) === null || d === void 0
                  ? void 0
                  : d.volume) ===
                  ((f = a.settings) === null || f === void 0
                    ? void 0
                    : f.volume)
              );
            },
          ...
          },
          {
            ...
            value: function (o, a) {
              return (
                ...
                (!o.videoTrack ||
                  !a.videoTrack ||
                  (o.videoTrack.id === a.videoTrack.id &&
                    o.videoTrack.muted === a.videoTrack.muted &&
                    o.videoTrack.enabled === a.videoTrack.enabled)) &&
                (!o.audioTrack ||
                  !a.audioTrack ||
                  (o.audioTrack.id === a.audioTrack.id &&
                    o.audioTrack.muted === a.audioTrack.muted &&
                    o.audioTrack.enabled === a.audioTrack.enabled))
              );
            },
          },
          {
          ...
          },
          {
            ...
            value: function (o) {
              ...
              if (o !== this._callState || a !== this._isPreparingToJoin) {
                ...
                g !== v &&
                  (this.updateKeepDeviceAwake(v),
                  this.updateDeviceAudioMode(v),
                  this.updateShowAndroidOngoingMeetingNotification(v),
                  this.updateNoOpRecordingEnsuringBackgroundContinuity(v));
              }
            },
          },
          {
            ...
            value: function () {
              (this._participants = {}),
                (this._participantCounts = rs),
                (this._waitingParticipants = {}),
                (this._activeSpeaker = {}),
                (this._activeSpeakerMode = !1),
                (this._didPreAuth = !1),
                (this._accessState = { access: Jt }),
                (this._finalSummaryOfPrevSession = this._meetingSessionSummary),
                (this._meetingSessionSummary = {}),
                (this._meetingSessionState = ar(ns, this._callObjectMode)),
          ...
          },
          {
            ...
            value: function (o) {
              N() &&
                this.nativeUtils().setKeepDeviceAwake(o, this._callFrameId);
            },
          },
          {
            ...
            value: function () {
              ...
              if (N()) {
                ...
                for (var f in d == null ? void 0 : d.streams) {
                  ...
                  g &&
                    g.pendingTrack &&
                    g.pendingTrack.kind === "audio" &&
                    (g.pendingTrack.enabled = this._hasNativeAudioFocus);
                }
              }
            },
          },
          {
            ...
            value: function (o) {
              return (
                ...
                this.properties.reactNativeConfig.disableAutoDeviceManagement[o]
              );
            },
          },
          {
          ...
          },
          {
            ...
            value: function (o) {
              if (this._callMachineInitialized) {
                var a = { action: bt, level: "info", code: 1012, results: o };
                this.sendMessageToCallMachine(a);
              } else
                console.warn(
          ...
          },
          {
            ...
            value: function () {
              var o = fe._callMachineInitialized
                ? fe
                : this._callMachineInitialized
                ? this
                : void 0;
              o
                ? (o.sendMessageToCallMachine({
                  ...
                  (this._delayDuplicateInstanceLog = !1))
                : ((this._delayDuplicateInstanceLog = !0),
                  (fe._delayDuplicateInstanceLog = !0));
            },
          },
          {
            ...
            value: function (o) {
              ...
              if (
                !(
                  ...
                  a !== void 0 &&
                  a.type &&
                  !["connection-error", "end-of-life", "no-room"].includes(
                    o.error.type
                  )
                )
              ) {
                var k =
                    (d = this.properties) !== null && d !== void 0 && d.url
                      ? new URL(this.properties.url)
                      : void 0,
                  P = "production";
                ...
                var J,
                  ...
                  ur = new ja({
                    ...
                    transport: Fa,
                    integrations: [
                      new Ii.GlobalHandlers({ onunhandledrejection: !1 }),
                      new Ii.HttpContext(),
                    ],
                    environment: P,
                  }),
                ...
                if (
                  (this.session_id && Q.setExtra("sessionId", this.session_id),
                  this.properties)
                ) {
                  var ge = A({}, this.properties);
                  (ge.userName = ge.userName ? "[Filtered]" : void 0),
                    (ge.userData = ge.userData ? "[Filtered]" : void 0),
                    (ge.token = ge.token ? "[Filtered]" : void 0),
                    Q.setExtra("properties", ge);
                }
                if (k) {
                ...
                o.error &&
                  (Q.setTag("fatalErrorType", o.error.type),
                  Q.setExtra("errorDetails", o.error.details),
                  !((J = o.error.details) === null || J === void 0) &&
                    J.uri &&
                    Q.setTag("serverAddress", o.error.details.uri),
                  !((H = o.error.details) === null || H === void 0) &&
                    H.workerGroup &&
                    Q.setTag("workerGroup", o.error.details.workerGroup),
                  !((K = o.error.details) === null || K === void 0) &&
                    K.geoGroup &&
                    Q.setTag("geoGroup", o.error.details.geoGroup),
                  !((ie = o.error.details) === null || ie === void 0) &&
                    ie.on &&
                    Q.setTag("connectionAttempt", o.error.details.on),
                  (q = o.error.details) !== null &&
                    q !== void 0 &&
                    q.bundleUrl &&
                    (Q.setTag("bundleUrl", o.error.details.bundleUrl),
                    Q.setTag("bundleError", o.error.details.sourceError.type))),
                  Q.setTags({
                ...
                var M =
                  ((E = o.error) === null || E === void 0 ? void 0 : E.msg) ||
                  o.errorMsg;
                Q.run(function (kl) {
          ...
          },
          {
            ...
            value: function () {
              var o, a, d;
              return (o = window._daily) === null ||
                o === void 0 ||
                (a = o.instances) === null ||
                a === void 0 ||
                (d = a[this._callFrameId]) === null ||
                d === void 0
                ? void 0
                : d.callMachine;
            },
        ...
        [
          ...
          },
          {
            ...
            value: function () {
              ...
              return (
                (a.allow = "microphone; camera; autoplay"),
                (a.style.cssText = `
      position: fixed;
      top: 0;
      left: 0;
    ...
    for (var r in n)
      if (n[r] instanceof MediaStreamTrack) t[r] = St;
        ...
        if (n[r].modifyLocalSdpHook) {
          ...
          (i.modifyLocalSdpHook = n[r].modifyLocalSdpHook),
            (window._daily.instances[e].customCallbacks = i),
            delete n[r].modifyLocalSdpHook;
        }
        if (n[r].modifyRemoteSdpHook) {
          var s = window._daily.instances[e].customCallbacks || {};
          (s.modifyRemoteSdpHook = n[r].modifyRemoteSdpHook),
            (window._daily.instances[e].customCallbacks = s),
            delete n[r].modifyRemoteSdpHook;
        }
        t[r] = n[r];
      } else t[r] = n[r];
    return t;
    ...
    if (!n) {
      var t = "".concat(
        arguments.length > 1 && arguments[1] !== void 0
          ? arguments[1]
          : "This daily-js method",
        " requires preAuth(), startCamera(), or join() to initialize call state."
      );
      throw (e && (t += " ".concat(e)), console.error(t), new Error(t));
    }
  }
  function qe(n) {
    if (n) {
      var e = "A pre-call quality test is in progress. Please try ".concat(
        arguments.length > 1 && arguments[1] !== void 0
          ? arguments[1]
          : "This daily-js method",
    ...
    if (!n) {
      var e = "".concat(
        arguments.length > 1 && arguments[1] !== void 0
          ? arguments[1]
          : "This daily-js method",
        " is only supported on custom callObject instances"
      );
      throw (console.error(e), new Error(e));
    }
  }
    ...
    if (n) {
      var e = "".concat(
        arguments.length > 1 && arguments[1] !== void 0
          ? arguments[1]
          : "This daily-js method",
        " is only supported as part of Daily's Prebuilt"
      );
      throw (console.error(e), new Error(e));
    }
  }
    ...
    if (e.length > 4096)
      throw Error(
        "userData is too large ("
          .concat(e.length, " characters). Maximum size suppported is ")
          .concat(4096, ".")
      );
    return !0;
  }
    ...
    for (
      var t = e.allowAllParticipantsKey,
        ...
        i = function (m) {
          return !!(
            m.layer === void 0 ||
            (Number.isInteger(m.layer) && m.layer >= 0) ||
            m.layer === "inherit"
          );
        },
        s = function (m) {
            ...
            return !i ||
              ...
              !(function (c) {
                return typeof c != "string"
                  ? !1
                  : Object.values(Xt).includes(c)
                  ? !0
                  : (console.error(
                      "inputSettings video processor type invalid"
                    ),
                    !1);
              })(i.type) ||
              (i.config &&
                (j(i.config) !== "object" ||
                  !(function (c, l) {
                    ...
                    switch (c) {
                      case Xt.BGBLUR:
                        return u.length > 1 || u[0] !== "strength"
                          ? (console.error(h), !1)
                          : !(
        ...
        (j(n.audio) !== "object" ||
          ...
          !t ||
            ...
            (Object.keys(t)
              ...
              .forEach(function (i) {
                console.warn(
                  "invalid key inputSettings -> audio -> processor : ".concat(i)
                ),
                  delete t[i];
              }),
            (e = t.type),
  ...
  function ds(n, e) {
    ...
    n.video &&
      !jo(
        (t = e == null ? void 0 : e.useLegacyVideoProcessor) !== null &&
          t !== void 0 &&
          t
      ) &&
      (delete n.video, r.push("video")),
      n.audio && !Fo() && (delete n.audio, r.push("audio")),
      r.length > 0 &&
        console.error(
          "Ignoring settings for browser- or platform-unsupported input processor(s): ".concat(
            r.join(", ")
          )
        );
  }
  function sr() {
    ...
    return "inputSettings must be of the form: { video?: { processor: { type: [ "
      .concat(n, " ], config?: {} } }, audio?: { processor: {type: [ ")
      .concat(e, " ] } } }");
  }
  function hs(n) {
  ...
  function ps() {
    return "customIntegrations should be an object of type ".concat(
      JSON.stringify(ir),
      "."
    );
  }
  function fs(n) {
    if ((n && j(n) !== "object") || Array.isArray(n))
      return (
        console.error(
    ...
    if (n)
      for (var e = 0, t = Object.entries(n); e < t.length; e++)
        for (
          var r = Ne(t[e], 1)[0], i = 0, s = Object.entries(n[r]);
          i < s.length;
          i++
        ) {
          var c = Ne(s[i], 2),
          ...
          if (
            (l === "iconPath" && !ut(u)) ||
            (l === "iconPathDarkMode" && !ut(u))
          )
            return (
              console.error("customTrayButton ".concat(l, " should be a url.")),
              !1
            );
          var h = tn.id[l];
          if (!h)
            return (
              console.error("customTrayButton does not support key ".concat(l)),
              !1
            );
          if (j(u) !== h)
            return (
              console.error(
                "customTrayButton ".concat(l, " should be a ").concat(h, ".")
              ),
              !1
            );
        }
  ...
  function ms(n) {
    if (!n || (n && j(n) !== "object") || Array.isArray(n))
      return console.error(ps()), !1;
    for (
      var e = function (m) {
        ...
        switch (h) {
          ...
          default:
            if (!ir.id[h])
              return (
                console.error(
                  "customIntegration does not support key ".concat(h)
                ),
                !1
              );
        }
  ...
  function gs(n, e) {
    ...
    switch (j(e)) {
      ...
      case "object":
        ...
        for (var t in n) if (!gs(n[t], e[t])) return !1;
        return !0;
      default:
        return !1;
    }
  ...
  function vs(n) {
    ...
    if (n.state && !Object.values(Gn).includes(n.state))
      throw new Error(
  ...
  var cr = { exports: {} },
    ...
    ys =
      st && typeof st.apply == "function"
        ? st.apply
        : function (e, t, r) {
            return Function.prototype.apply.call(e, t, r);
          },
    on;
  st && typeof st.ownKeys == "function"
    ? (on = st.ownKeys)
    : Object.getOwnPropertySymbols
    ? (on = function (e) {
  ...
  (R.prototype.getMaxListeners = function () {
    ...
    (R.prototype.emit = function (e) {
      ...
      if (typeof u == "function") ys(u, this, t);
        ...
        for (var h = u.length, p = Ms(u, h), r = 0; r < h; ++r)
          ys(p[r], this, t);
      return !0;
    });
  function Es(n, e, t, r) {
  ...
  (R.prototype.once = function (e, t) {
    ...
    (R.prototype.removeListener = function (e, t) {
      ...
      if (r === t || r.listener === t)
        ...
        s === 0 ? r.shift() : tl(r, s),
          r.length === 1 && (i[e] = r[0]),
          i.removeListener !== void 0 && this.emit("removeListener", e, l || t);
      }
      return this;
    }),
  ...
  function rl(n, e) {
    return new Promise(function (t, r) {
      ...
      As(n, e, s, { once: !0 }), e !== "error" && il(n, i, { once: !0 });
    });
  }
  function il(n, e, t) {
  ...
  (function (n) {
    (n.Json = "application/json"),
      (n.FormData = "multipart/form-data"),
      (n.UrlEncoded = "application/x-www-form-urlencoded"),
      (n.Text = "text/plain");
  })(U || (Ie.ContentType = U = {}));
  class Os {
    constructor(e = {}) {
      ...
      V(this, "contentFormatters", {
        [U.Json]: (e) =>
          e !== null && (typeof e == "object" || typeof e == "string")
            ? JSON.stringify(e)
            : e,
        [U.Text]: (e) =>
          e !== null && typeof e != "string" ? JSON.stringify(e) : e,
        [U.FormData]: (e) =>
      ...
      V(
        ...
        async ({
          ...
          const p =
              ((typeof t == "boolean" ? t : this.baseApiParams.secure) &&
                this.securityWorker &&
          ...
          return this.customFetch(
            `${l || this.baseUrl || ""}${r}${y ? `?${y}` : ""}`,
            {
              ...m,
              headers: {
                ...(m.headers || {}),
                ...(i && i !== U.FormData ? { "Content-Type": i } : {}),
              },
            ...
            const L = b
              ? await S[b]()
                  .then((G) => (T.ok ? (T.data = G) : (T.error = G), T))
                  .catch((G) => ((T.error = G), T))
              : T;
    ...
    encodeQueryParam(e, t) {
      return `${encodeURIComponent(
        e
      )}=${encodeURIComponent(typeof t == "number" ? t : `${t}`)}`;
    }
    addQueryParam(e, t) {
    ...
    toQueryString(e) {
      ...
      return Object.keys(t)
        ...
        .map((i) =>
          Array.isArray(t[i])
            ? this.addArrayQueryParam(t, i)
            : this.addQueryParam(t, i)
        )
        .join("&");
    }
    addQueryParams(e) {
  ...
  class sl extends Os {
    constructor() {
      ...
      V(this, "assistant", {
        ...
        assistantControllerFindAll: (t, r = {}) =>
          this.request({
            path: "/assistant",
            method: "GET",
            query: t,
        ...
        assistantControllerFindOne: (t, r = {}) =>
          this.request({
            path: `/assistant/${t}`,
            method: "GET",
            secure: !0,
        ...
        assistantControllerUpdate: (t, r, i = {}) =>
          this.request({
            path: `/assistant/${t}`,
            method: "PATCH",
            body: r,
        ...
        assistantControllerReplace: (t, r, i = {}) =>
          this.request({
            path: `/assistant/${t}`,
            method: "PUT",
            body: r,
      ...
      V(this, "call", {
        ...
        callControllerDeleteCallData: (t, r = {}) =>
          this.request({
            path: `/call/${t}`,
            method: "DELETE",
            secure: !0,
        ...
        callControllerCreatePhoneCall: (t, r = {}) =>
          this.request({
            path: "/call/phone",
            method: "POST",
            body: t,
        ...
        callControllerCreateWebCall: (t, r = {}) =>
          this.request({
            path: "/call/web",
            method: "POST",
            body: t,
      ...
      V(this, "credential", {
        credentialControllerCreate: (t, r = {}) =>
          this.request({
            path: "/credential",
            method: "POST",
            body: t,
        ...
        credentialControllerFindAll: (t, r = {}) =>
          this.request({
            path: "/credential",
            method: "GET",
            query: t,
        ...
        credentialControllerFindOne: (t, r = {}) =>
          this.request({
            path: `/credential/${t}`,
            method: "GET",
            secure: !0,
        ...
        credentialControllerUpdate: (t, r, i = {}) =>
          this.request({
            path: `/credential/${t}`,
            method: "PUT",
            body: r,
        ...
        credentialControllerRemove: (t, r = {}) =>
          this.request({
            path: `/credential/${t}`,
            method: "DELETE",
            secure: !0,
      ...
      V(this, "phoneNumber", {
        ...
        phoneNumberControllerImportTwilio: (t, r = {}) =>
          this.request({
        ...
        phoneNumberControllerImportVonage: (t, r = {}) =>
          this.request({
        ...
        phoneNumberControllerFindAll: (t, r = {}) =>
          this.request({
            path: "/phone-number",
            method: "GET",
            query: t,
        ...
        phoneNumberControllerFindOne: (t, r = {}) =>
          this.request({
            path: `/phone-number/${t}`,
            method: "GET",
            secure: !0,
        ...
        phoneNumberControllerUpdate: (t, r, i = {}) =>
          this.request({
            path: `/phone-number/${t}`,
            method: "PATCH",
            body: r,
        ...
        phoneNumberControllerRemove: (t, r = {}) =>
          this.request({
            path: `/phone-number/${t}`,
            method: "DELETE",
            secure: !0,
  ...
  async function hl(n, e) {
    (n.muted = !1),
      (n.autoplay = !0),
      e != null && ((n.srcObject = new MediaStream([e])), await n.play());
  }
  async function pl(n, e) {
    const t = document.createElement("audio");
    return (
      (t.dataset.participantId = e),
  ...
  function fl(n, e, t) {
    n.participant.local ||
      e.updateParticipant(n.participant.session_id, {
        setSubscribedTracks: { audio: !0, video: t },
      });
  }
  ...
  class gl extends ml {
    constructor(t, r) {
      ...
      (lr.client.baseUrl = r ?? "https://api.vapi.ai"),
        lr.client.setSecurityData(t);
    }
    cleanup() {
      var t;
      (this.started = !1),
        (t = this.call) == null || t.destroy(),
        (this.call = null),
    ...
    async start(t, r, i) {
      ...
      try {
        const l = (
          await lr.client.call.callControllerCreateWebCall({
        ...
        const u =
          ((s = l == null ? void 0 : l.artifactPlan) == null
            ? void 0
            : s.videoRecordingEnabled) ?? !1;
        if (
          ((this.call = ll.default.createCallObject({
            audioSource: !0,
            videoSource: u,
          })),
          (c = this.call.iframe()) == null ||
            c.style.setProperty("display", "none"),
          this.call.on("left-meeting", () => {
            var h;
            this.emit("call-end"),
              u && ((h = this.call) == null || h.stopRecording()),
              this.cleanup();
          }),
          ...
          this.call.on("error", (h) => {
            var p;
            this.emit("error", h),
              u && ((p = this.call) == null || p.stopRecording());
          }),
          ...
          this.call.on("track-started", async (h) => {
            ...
            !h ||
              !h.participant ||
              ((p = h.participant) != null && p.local) ||
              (h.track.kind === "audio" &&
                (await pl(h.track, h.participant.session_id),
                ((m = h == null ? void 0 : h.participant) == null
                  ? void 0
                  : m.user_name) === "Vapi Speaker" &&
                  ((y = this.call) == null || y.sendAppMessage("playable"))));
          }),
            ...
            this.call.on("recording-started", () => {
              this.send({
                ...
                videoRecordingStartDelaySeconds:
                  (new Date().getTime() - h) / 1e3,
              });
            });
        }
        return (
          this.call.startRemoteParticipantsAudioLevelObserver(100),
          this.call.on("remote-participants-audio-level", (h) => {
            h && this.handleRemoteParticipantsAudioLevel(h);
          }),
          this.call.on("app-message", (h) => this.onAppMessage(h)),
          this.call.on("nonfatal-error", (h) => {
            var p;
            (h == null ? void 0 : h.type) === "audio-processor-error" &&
              ((p = this.call) == null ||
                p
                  .updateInputSettings({
    ...
    handleRemoteParticipantsAudioLevel(t) {
      const r = Object.values(t.participantsAudioLevel).reduce(
        (s, c) => s + c,
        0
      );
    ...
    say(t, r) {
      this.send({ type: "say", message: t, endCallAfterSpoken: r });
    }
  ...
  `;
      for (let m = 0; m <= 10; m++)
        p.innerText += `
      .vapi-btn-volume-${m} {
        box-shadow: 1px 1px ${5 + m * 2}px ${m * 2}px ${
          t.color
    ...
    yl = (
      ...
      return (
        (u.id = l),
        (u.className = "vapi-btn vapi-btn-round vapi-btn-is-idle"),
        (u.onclick = () => {}),
        u
      );
    },
    ...
    bl = (n) => (e, t) => {
      ...
      if (r) {
        if (
          ((e.className = `vapi-btn vapi-btn-is-${t} ${
            r.type === "pill"
              ? "vapi-btn-pill"
              : r.type === "round"
              ? "vapi-btn-round"
          ...
          (s.src = r.icon || Ps), (s.alt = "Icon"), i.appendChild(s);
    ...
    const l = () => {
      s(e, "loading"),
        c
          ...
          : (t || r
              ? n.start(t, r)
              : (console.log("squad ,", i, t, r), n.start(void 0, void 0, i)),
            (c = !0));
    };
    n.on("call-start", () => {
      s(e, "active");
    ...
    function c(h, p) {
      ...
      return (
        Object.keys(p).forEach((y) => {
          typeof p[y] == "object" && p[y] !== null && !Array.isArray(p[y])
            ? (m[y] = c(h[y] || {}, p[y]))
            : (m[y] = p[y]);
        }),
        m
